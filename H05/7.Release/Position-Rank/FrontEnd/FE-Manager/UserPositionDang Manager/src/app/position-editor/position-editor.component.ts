...
@Component({
    ...
    templateUrl: 
		...
		'/o/UserPositionDang-Manager/app/position-editor.component.html'
})
export class PositionDangEditorConponent implements OnInit{
    pageSize= 5;
    page = 1;
    listSize = 0;
    imgSrc: any;
    ...
    updateform = this.fb.group({
        ...
        userPoisitionDangName: ['', [Validators.required, Validators.maxLength(500),Validators.pattern(".*\\S.*")]],
        description: ['', [Validators.maxLength(500),Validators.pattern(".*\\S.*")]],
    });
    get userPoisitionDangName(){ 
        return this.updateform.get('userPoisitionDangName');
    }
        ...
        if(this.rankId !=null){
            this.service.getCategory(this.rankId).subscribe((res:any)=>{
                this.updateform.patchValue({
                    userPoisitionDangName:res.data.userPoisitionDangName,
