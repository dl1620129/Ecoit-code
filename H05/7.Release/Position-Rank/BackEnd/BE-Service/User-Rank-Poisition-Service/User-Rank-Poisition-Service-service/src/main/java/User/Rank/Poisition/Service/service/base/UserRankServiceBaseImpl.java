...
import User.Rank.Poisition.Service.service.UserRankService;
...
/**
 * Provides the base implementation for the user rank remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link User.Rank.Poisition.Service.service.impl.UserRankServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see User.Rank.Poisition.Service.service.impl.UserRankServiceImpl
 * @generated
 */
public abstract class UserRankServiceBaseImpl
	extends BaseServiceImpl
	implements UserRankService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UserRankService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>User.Rank.Poisition.Service.service.UserRankServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UserRankService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		userRankService = (UserRankService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserRankService.class.getName();
	}
	...
	@Reference
	protected User.Rank.Poisition.Service.service.UserRankLocalService
