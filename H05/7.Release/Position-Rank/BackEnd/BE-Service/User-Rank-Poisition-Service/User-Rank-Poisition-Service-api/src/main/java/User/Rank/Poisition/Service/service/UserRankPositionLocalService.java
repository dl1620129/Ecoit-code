...
/**
 * Provides the local service interface for UserRankPosition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserRankPositionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserRankPositionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserRankPositionLocalServiceUtil} to access the user rank position local service. Add custom service methods to <code>User.Rank.Poisition.Service.service.impl.UserRankPositionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public UserRankPosition addUserRankPosition(
	...
	public UserRankPosition createUserRankPosition(long userId);
	...
	public UserRankPosition deleteUserRankPosition(long userId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public UserRankPosition deleteUserRankPosition(
		UserRankPosition userRankPosition);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserRankPosition fetchUserRankPosition(long userId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserRankPosition getUserRankPosition(long userId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserRankPosition> getUserRankPositions(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserRankPosition updateUserRankPosition(
		UserRankPosition userRankPosition);
