<div class="ted" id="main-content" role="main">
	...
	<div class="container">
		<div class="portlet-layout row">
			<div class="col-md-9 portlet-column portlet-column-first row" id="column-5">
	...
	<div class="container">
		<div class="portlet-layout row">
			<div class="col-md-6 portlet-column portlet-column-only" id="column-13">
				${processor.processColumn("column-13", "portlet-column-content portlet-column-content-only")}
			</div>
			<div class="col-md-6 portlet-column portlet-column-only" id="column-14">
				${processor.processColumn("column-14", "portlet-column-content portlet-column-content-only")}
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="portlet-layout row">
			<div class="col-md-6 portlet-column portlet-column-only" id="column-17">
				${processor.processColumn("column-17", "portlet-column-content portlet-column-content-only")}
			</div>
			<div class="col-md-6 portlet-column portlet-column-only" id="column-18">
				${processor.processColumn("column-18", "portlet-column-content portlet-column-content-only")}
			</div>
		</div>
	</div>
