 ...
 * @generated
 */
public class GroupUserUsersPK
	implements Comparable<GroupUserUsersPK>, Serializable {

	public long groupUserId;
	public long userId;

	public GroupUserUsersPK() {
	}

	public GroupUserUsersPK(long groupUserId, long userId) {
	...
	@Override
	public int compareTo(GroupUserUsersPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GroupUserUsersPK)) {
			return false;
		}

		GroupUserUsersPK pk = (GroupUserUsersPK)obj;
