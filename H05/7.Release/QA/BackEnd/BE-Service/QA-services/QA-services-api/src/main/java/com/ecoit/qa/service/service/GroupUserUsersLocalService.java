...
public interface GroupUserUsersLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GroupUserUsersLocalServiceUtil} to access the group user users local service. Add custom service methods to <code>com.ecoit.qa.service.service.impl.GroupUserUsersLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
