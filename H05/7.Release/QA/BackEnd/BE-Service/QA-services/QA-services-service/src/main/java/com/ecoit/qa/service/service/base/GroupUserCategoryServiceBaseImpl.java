...
import com.ecoit.qa.service.service.GroupUserCategoryService;
...
/**
 * Provides the base implementation for the group user category remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.qa.service.service.impl.GroupUserCategoryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ecoit.qa.service.service.impl.GroupUserCategoryServiceImpl
 * @generated
 */
public abstract class GroupUserCategoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GroupUserCategoryService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GroupUserCategoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.qa.service.service.GroupUserCategoryServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GroupUserCategoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		groupUserCategoryService = (GroupUserCategoryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GroupUserCategoryService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.qa.service.service.GroupUserCategoryLocalService
		groupUserCategoryLocalService;

	protected GroupUserCategoryService groupUserCategoryService;
