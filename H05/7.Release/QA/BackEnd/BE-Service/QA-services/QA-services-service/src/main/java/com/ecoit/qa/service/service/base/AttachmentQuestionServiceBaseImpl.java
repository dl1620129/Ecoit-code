...
import com.ecoit.qa.service.service.AttachmentQuestionService;
...
/**
 * Provides the base implementation for the attachment question remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.qa.service.service.impl.AttachmentQuestionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ecoit.qa.service.service.impl.AttachmentQuestionServiceImpl
 * @generated
 */
public abstract class AttachmentQuestionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttachmentQuestionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttachmentQuestionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.qa.service.service.AttachmentQuestionServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttachmentQuestionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attachmentQuestionService = (AttachmentQuestionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttachmentQuestionService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.qa.service.service.AttachmentQuestionLocalService
		attachmentQuestionLocalService;

	protected AttachmentQuestionService attachmentQuestionService;
