...
public class CategoryLocalServiceUtil {
	...
	public static com.software.cms.model.Category createCategory(
		...
		return getService().createCategory(
	...
	public static int getMax(
		long userId, String lang, long groupId, long parentId) {

		return getService().getMax(userId, lang, groupId, parentId);
	}
	...
	public static java.util.List<com.software.cms.model.Category> getNode(
	...
	public static int getNodeCount(
		...
		return getService().getNodeCount(parentId, groupId, language, title);
	}
