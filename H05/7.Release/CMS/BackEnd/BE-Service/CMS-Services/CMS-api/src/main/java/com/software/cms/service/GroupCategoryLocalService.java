...
public interface GroupCategoryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GroupCategoryLocalServiceUtil} to access the group category local service. Add custom service methods to <code>com.software.cms.service.impl.GroupCategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
