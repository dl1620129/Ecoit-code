...
public class MapCateLayoutLocalServiceUtil {
	...
	public static int countMapCateLayout(long groupId, long companyId)
		throws Exception {

		return getService().countMapCateLayout(groupId, companyId);
	}
	...
	public static java.util.List<com.software.cms.model.MapCateLayout>
			getListMapCateLayout(
				long groupId, long companyId, int start, int limit)
		throws Exception {

		return getService().getListMapCateLayout(
			groupId, companyId, start, limit);
	}
