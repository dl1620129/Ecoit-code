...
public interface EventLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EventLocalServiceUtil} to access the event local service. Add custom service methods to <code>com.software.cms.service.impl.EventLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Event> getEventByLanguage(String language);
