 ...
 * @generated
 */
public abstract class TagFinderBaseImpl extends BasePersistenceImpl<Tag> {

	public TagFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return tagPersistence.getBadColumnNames();
	}
