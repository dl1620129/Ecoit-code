...
import com.software.cms.service.CategoryArticleService;
...
/**
 * Provides the base implementation for the category article remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.software.cms.service.impl.CategoryArticleServiceImpl}.
 * </p>
 *
 * @author DungNV
 * @see com.software.cms.service.impl.CategoryArticleServiceImpl
 * @generated
 */
public abstract class CategoryArticleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CategoryArticleService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CategoryArticleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.software.cms.service.CategoryArticleServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CategoryArticleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		categoryArticleService = (CategoryArticleService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CategoryArticleService.class.getName();
	}
	...
	@Reference
	protected com.software.cms.service.CategoryArticleLocalService
		categoryArticleLocalService;

	protected CategoryArticleService categoryArticleService;
