 ...
 * @generated
 */
public abstract class LoggerFinderBaseImpl extends BasePersistenceImpl<Logger> {

	public LoggerFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return loggerPersistence.getBadColumnNames();
	}
