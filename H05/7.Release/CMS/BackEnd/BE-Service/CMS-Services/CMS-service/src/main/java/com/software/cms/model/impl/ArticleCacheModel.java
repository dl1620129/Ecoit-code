...
public class ArticleCacheModel implements CacheModel<Article>, Externalizable {
	...
	public String toString() {
		...
		sb.append(", isTimer=");
		sb.append(isTimer);
		sb.append(", humanAccess=");
		sb.append(humanAccess);
		sb.append(", humanAccessIds=");
		sb.append(humanAccessIds);
		sb.append("}");
	...
	public Article toEntityModel() {
		...
		if (humanAccess == null) {
			articleImpl.setHumanAccess("");
		}
		else {
			articleImpl.setHumanAccess(humanAccess);
		}

		if (humanAccessIds == null) {
			articleImpl.setHumanAccessIds("");
		}
		else {
			articleImpl.setHumanAccessIds(humanAccessIds);
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		humanAccess = objectInput.readUTF();
		humanAccessIds = objectInput.readUTF();
	}
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		if (humanAccess == null) {
			...
			objectOutput.writeUTF(humanAccess);
		}
		...
		if (humanAccessIds == null) {
			...
			objectOutput.writeUTF(humanAccessIds);
		}
	}
	...
	public String humanAccess;
	public String humanAccessIds;
