...
public class AttachmentUtil {
	...
	public static long uploadFile(UploadServletRequest upload, Article article, File file, String title,
			...
			if (article.getFolderId() <= 0) {
				try {
					dlFolder = DLFolderLocalServiceUtil.getFolder(scopeGroupId, folderMonth.getFolderId(),
							"ArticleImage_" + article.getArticleId());
				} catch (Exception e) {
					dlFolder = null;
				}
				if (dlFolder == null) {
					dlFolder = DLFolderLocalServiceUtil.addFolder(userId, scopeGroupId, scopeGroupId, false,
							folderMonth.getFolderId(), "ArticleImage_" + article.getArticleId(), article.getTitle(),
...
//			e.printStackTrace();
	...
	public static long uploadFileResize(UploadPortletRequest upload, Article article, File file, String title, int w,
