package cms.permisstion.utils.response;
...
public class DataResponse {
    ...
    public static final DataResponse PARAM_ERROR = new DataResponse(ResponseCode.FAILED, ResponseCode.FAILED, ResponseCode.PARAM_ERROR);
