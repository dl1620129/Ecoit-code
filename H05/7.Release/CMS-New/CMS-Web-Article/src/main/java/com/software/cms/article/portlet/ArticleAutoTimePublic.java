...
public class ArticleAutoTimePublic extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		 ...
		 */
		String sql = "SELECT * FROM soft_cms_article where isTimer = true AND publisheddatefrom <= '" + sdf.format(dt)
				+ "' AND status NOT IN (10,5,6,1)";// 5,6
		List<Article> article = ArticleLocalServiceUtil.getArticleTheoSQL(sql);
