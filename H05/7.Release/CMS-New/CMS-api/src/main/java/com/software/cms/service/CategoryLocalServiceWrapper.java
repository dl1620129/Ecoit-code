...
public class CategoryLocalServiceWrapper
	...
	@Override
	public com.software.cms.model.Category prepCategory(
		...
		return _categoryLocalService.prepCategory(
	...
	@Override
	public java.util.List<com.software.cms.model.Category> searchCategory(
		String key) {

		return _categoryLocalService.searchCategory(key);
	}
