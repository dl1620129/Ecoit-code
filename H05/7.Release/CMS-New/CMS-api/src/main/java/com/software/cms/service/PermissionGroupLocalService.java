...
/**
 * Provides the local service interface for PermissionGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author DungNV
 * @see PermissionGroupLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PermissionGroupLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PermissionGroupLocalServiceUtil} to access the permission group local service. Add custom service methods to <code>com.software.cms.service.impl.PermissionGroupLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public PermissionGroup addPermissionGroup(PermissionGroup permissionGroup);
	...
	public PermissionGroup deletePermissionGroup(
	...
	public void doAddGroupUser(
			ThemeDisplay themeDisplay, long groupUserId, String groupName,
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PermissionGroup fetchPermissionGroup(
		PermissionGroupPK permissionGroupPK);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PermissionGroup> getPermissionGroups(int start, int end);
