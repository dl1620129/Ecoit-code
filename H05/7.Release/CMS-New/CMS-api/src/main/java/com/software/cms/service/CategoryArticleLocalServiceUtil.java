...
public class CategoryArticleLocalServiceUtil {
	...
	public static void addCategoryArticle(long articleId, String categoryId) {
		getService().addCategoryArticle(articleId, categoryId);
	}
	...
	public static int getCountById(long catId) {
