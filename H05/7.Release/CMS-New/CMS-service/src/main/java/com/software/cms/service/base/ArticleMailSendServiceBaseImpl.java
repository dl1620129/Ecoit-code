...
import com.software.cms.service.ArticleMailSendService;
...
/**
 * Provides the base implementation for the article mail send remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.software.cms.service.impl.ArticleMailSendServiceImpl}.
 * </p>
 *
 * @author DungNV
 * @see com.software.cms.service.impl.ArticleMailSendServiceImpl
 * @generated
 */
public abstract class ArticleMailSendServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ArticleMailSendService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ArticleMailSendService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.software.cms.service.ArticleMailSendServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ArticleMailSendService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		articleMailSendService = (ArticleMailSendService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ArticleMailSendService.class.getName();
	}
	...
	@Reference
	protected com.software.cms.service.ArticleMailSendLocalService
		articleMailSendLocalService;

	protected ArticleMailSendService articleMailSendService;
