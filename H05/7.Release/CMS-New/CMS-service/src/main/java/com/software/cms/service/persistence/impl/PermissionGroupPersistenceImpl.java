...
public class PermissionGroupPersistenceImpl
	...
	public List<PermissionGroup> findByGroup_GroupUser(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_PERMISSIONGROUP_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(PermissionGroupModelImpl.ORDER_BY_JPQL);
			}
	...
	public PermissionGroup findByGroup_GroupUser_First(
		...
		throw new NoSuchPermissionGroupException(sb.toString());
	}
	...
	public int countByGroup_GroupUser(long groupId, long groupuserid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_PERMISSIONGROUP_WHERE);
	...
	public List<PermissionGroup> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_PERMISSIONGROUP);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_PERMISSIONGROUP);
