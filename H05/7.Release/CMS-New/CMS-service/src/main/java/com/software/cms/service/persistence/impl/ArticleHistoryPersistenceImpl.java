...
public class ArticleHistoryPersistenceImpl
	...
	public List<ArticleHistory> findByUuid(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ARTICLEHISTORY_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(ArticleHistoryModelImpl.ORDER_BY_JPQL);
			}
	...
	public ArticleHistory findByUuid_First(
		...
		throw new NoSuchArticleHistoryException(sb.toString());
	}
	...
	protected ArticleHistory getByUuid_PrevAndNext(
		...
		List<ArticleHistory> list = query.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ARTICLEHISTORY_WHERE);
	...
	public List<ArticleHistory> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ARTICLEHISTORY);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_ARTICLEHISTORY);
