...
public class CategoryPersistenceImpl
	...
	public List<Category> findByGroup_Language_Parent(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_PARENT_GROUPID_2);

			boolean bindLanguage = false;

			if (language.isEmpty()) {
				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_PARENT_LANGUAGE_3);
			}
			else {
				bindLanguage = true;

				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_PARENT_LANGUAGE_2);
			}

			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_PARENT_PARENTID_2);
