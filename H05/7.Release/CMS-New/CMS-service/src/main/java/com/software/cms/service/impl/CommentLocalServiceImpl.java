 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.software.cms.service.CommentLocalService</code> interface.
 *
 * <p>
 ...
 */
@Component(
	property = "model.class.name=com.software.cms.model.Comment",
...
public class CommentLocalServiceImpl extends CommentLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>com.software.cms.service.CommentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.software.cms.service.CommentLocalServiceUtil</code>.
	 */
	public List<Comment> searchComment(Long id) {
		...
		try {
			...
			String sql = "SELECT * FROM soft_cms_comment WHERE articleId = ?";
