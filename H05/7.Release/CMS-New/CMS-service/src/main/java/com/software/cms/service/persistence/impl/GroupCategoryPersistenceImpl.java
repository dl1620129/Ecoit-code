...
public class GroupCategoryPersistenceImpl
	...
	public List<GroupCategory> findByGroupUser(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_GROUPCATEGORY_WHERE);

			sb.append(_FINDER_COLUMN_GROUPUSER_GROUPUSERID_2);
			...
			if (orderByComparator != null) {
				...
				sb.append(GroupCategoryModelImpl.ORDER_BY_JPQL);
			}
	...
	public GroupCategory findByGroupUser_First(
		...
		throw new NoSuchGroupCategoryException(sb.toString());
	}
	...
	protected GroupCategory getByGroupUser_PrevAndNext(
		...
		List<GroupCategory> list = query.list();
	...
	public int countByGroupUser(long groupuserid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_GROUPCATEGORY_WHERE);
	...
	public List<GroupCategory> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_GROUPCATEGORY);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_GROUPCATEGORY);
