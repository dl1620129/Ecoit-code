...
public class ArticleConfigPersistenceImpl
	...
	public List<ArticleConfig> findByUuid(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ARTICLECONFIG_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(ArticleConfigModelImpl.ORDER_BY_JPQL);
			}
	...
	public ArticleConfig findByUuid_First(
		...
		throw new NoSuchArticleConfigException(sb.toString());
	}
	...
	protected ArticleConfig getByUuid_PrevAndNext(
		...
		List<ArticleConfig> list = query.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ARTICLECONFIG_WHERE);
	...
	public List<ArticleConfig> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ARTICLECONFIG);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_ARTICLECONFIG);
