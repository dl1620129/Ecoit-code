 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.software.cms.service.CategoryArticleLocalService</code> interface.
 *
 * <p>
 ...
 */
@Component(
	property = "model.class.name=com.software.cms.model.CategoryArticle",
	service = AopService.class
)
public class CategoryArticleLocalServiceImpl
	extends CategoryArticleLocalServiceBaseImpl {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>com.software.cms.service.CategoryArticleLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.software.cms.service.CategoryArticleLocalServiceUtil</code>.
	 */
	public List<CategoryArticle> findByCategory(long categoryId) {
		return categoryArticlePersistence.findByCategory(categoryId);
	}
	
	public void addCategoryArticle(long articleId, String categoryId) {
		try {
			CategoryArticlePK primKey = new CategoryArticlePK(articleId, Long.parseLong(categoryId));
	...
	public List<Long> getCategoryOfArticleWithId(long id_article) {
		...
		public int getCountById(long catId){
			Long count = 0L;
			Session session = null;
			StringBuffer sql = new StringBuffer();
			try {

				sql.append("SELECT COUNT(*) FROM soft_cms_categoryarticle where categoryid= "+catId);
