...
import com.software.cms.service.ArticleMessageService;
...
/**
 * Provides the base implementation for the article message remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.software.cms.service.impl.ArticleMessageServiceImpl}.
 * </p>
 *
 * @author DungNV
 * @see com.software.cms.service.impl.ArticleMessageServiceImpl
 * @generated
 */
public abstract class ArticleMessageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ArticleMessageService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ArticleMessageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.software.cms.service.ArticleMessageServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ArticleMessageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		articleMessageService = (ArticleMessageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ArticleMessageService.class.getName();
	}
	...
	@Reference
	protected com.software.cms.service.ArticleMessageLocalService
		articleMessageLocalService;

	protected ArticleMessageService articleMessageService;
