...
public class ArticleMessagePersistenceImpl
	...
	public List<ArticleMessage> findByUuid(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ARTICLEMESSAGE_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(ArticleMessageModelImpl.ORDER_BY_JPQL);
			}
	...
	public ArticleMessage findByUuid_First(
		...
		throw new NoSuchArticleMessageException(sb.toString());
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ARTICLEMESSAGE_WHERE);
	...
	public List<ArticleMessage> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ARTICLEMESSAGE);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_ARTICLEMESSAGE);
