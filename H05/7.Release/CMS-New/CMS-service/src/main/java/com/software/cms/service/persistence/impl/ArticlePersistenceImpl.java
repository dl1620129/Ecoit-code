...
public class ArticlePersistenceImpl
	...
	public Article fetchByFriendUrl(
		...
		if (result == null) {
			...
			if (friendlyURL.isEmpty()) {
				sb.append(_FINDER_COLUMN_FRIENDURL_FRIENDLYURL_3);
			}
			else {
				bindFriendlyURL = true;

				sb.append(_FINDER_COLUMN_FRIENDURL_FRIENDLYURL_2);
			}
	...
	public Article fetchByFriendUrlAndStatus(
		...
		if (result == null) {
			...
			if (friendlyURL.isEmpty()) {
				sb.append(_FINDER_COLUMN_FRIENDURLANDSTATUS_FRIENDLYURL_3);
			}
			else {
				bindFriendlyURL = true;

				sb.append(_FINDER_COLUMN_FRIENDURLANDSTATUS_FRIENDLYURL_2);
			}

			sb.append(_FINDER_COLUMN_FRIENDURLANDSTATUS_STATUS_2);
	...
	public List<Article> findByGroup_Language_Status(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_GROUPID_2);

			boolean bindLanguage = false;

			if (language.isEmpty()) {
				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_LANGUAGE_3);
			}
			else {
				bindLanguage = true;

				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_LANGUAGE_2);
			}

			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_STATUS_2);
	...
	public List<Article> findByGroup_Language_Status_Event(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_EVENT_GROUPID_2);
			...
			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_EVENT_STATUS_2);

			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_EVENT_EVENTID_2);
	...
	protected Article getByGroup_Language_Status_Event_PrevAndNext(
		...
		if (language.isEmpty()) {
			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_EVENT_LANGUAGE_3);
		}
		else {
			bindLanguage = true;

			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_EVENT_LANGUAGE_2);
		}
	...
	public List<Article> findByGroup_Language_Status_UserCreate(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_USERCREATE_STATUS_2);
	...
	protected Article getByGroup_Language_Status_UserCreate_PrevAndNext(
		...
		sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_STATUS_USERCREATE_GROUPID_2);
