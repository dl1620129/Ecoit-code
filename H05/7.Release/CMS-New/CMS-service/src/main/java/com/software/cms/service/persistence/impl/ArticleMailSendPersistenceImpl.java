...
public class ArticleMailSendPersistenceImpl
	...
	public List<ArticleMailSend> findByUuid(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ARTICLEMAILSEND_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(ArticleMailSendModelImpl.ORDER_BY_JPQL);
			}
	...
	public ArticleMailSend findByUuid_First(
		...
		throw new NoSuchArticleMailSendException(sb.toString());
	}
	...
	protected ArticleMailSend getByUuid_PrevAndNext(
		...
		List<ArticleMailSend> list = query.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ARTICLEMAILSEND_WHERE);
	...
	public List<ArticleMailSend> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ARTICLEMAILSEND);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_ARTICLEMAILSEND);
