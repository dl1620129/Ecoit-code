...
public class LoggerPersistenceImpl
	...
	public List<Logger> findByUuid(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_LOGGER_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(LoggerModelImpl.ORDER_BY_JPQL);
			}
	...
	public Logger findByUuid_First(
		...
		throw new NoSuchLoggerException(sb.toString());
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_LOGGER_WHERE);
	...
	public List<Logger> findByGroup_Language_User(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_USER_GROUPID_2);

			boolean bindLanguage = false;

			if (language.isEmpty()) {
				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_USER_LANGUAGE_3);
			}
			else {
				bindLanguage = true;

				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_USER_LANGUAGE_2);
			}

			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_USER_USERID_2);
	...
	public List<Logger> findByGroup_Language(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_GROUPID_2);

			boolean bindLanguage = false;

			if (language.isEmpty()) {
				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_LANGUAGE_3);
			}
			else {
				bindLanguage = true;

				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_LANGUAGE_2);
			}
	...
	public List<Logger> findByGroup_Language_Type(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_TYPE_GROUPID_2);

			boolean bindLanguage = false;

			if (language.isEmpty()) {
				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_TYPE_LANGUAGE_3);
			}
			else {
				bindLanguage = true;

				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_TYPE_LANGUAGE_2);
			}

			boolean bindType = false;

			if (type.isEmpty()) {
				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_TYPE_TYPE_3);
			}
			else {
				bindType = true;

				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_TYPE_TYPE_2);
			}
	...
	public List<Logger> findByGroup_Language_User_Type(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_USER_TYPE_GROUPID_2);

			boolean bindLanguage = false;

			if (language.isEmpty()) {
				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_USER_TYPE_LANGUAGE_3);
			}
			else {
				bindLanguage = true;

				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_USER_TYPE_LANGUAGE_2);
			}

			sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_USER_TYPE_USERID_2);

			boolean bindType = false;

			if (type.isEmpty()) {
				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_USER_TYPE_TYPE_3);
			}
			else {
				bindType = true;

				sb.append(_FINDER_COLUMN_GROUP_LANGUAGE_USER_TYPE_TYPE_2);
			}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_LOGGER);
