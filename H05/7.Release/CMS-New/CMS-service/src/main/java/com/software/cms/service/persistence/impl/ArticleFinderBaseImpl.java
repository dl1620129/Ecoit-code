 ...
 * @generated
 */
public abstract class ArticleFinderBaseImpl
	extends BasePersistenceImpl<Article> {

	public ArticleFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return articlePersistence.getBadColumnNames();
	}
