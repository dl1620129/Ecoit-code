...
public class GroupUserPersistenceImpl
	...
	public List<GroupUser> findByGroup_Language(
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_GROUPUSER_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(GroupUserModelImpl.ORDER_BY_JPQL);
			}
	...
	public GroupUser findByGroup_Language_First(
		...
		throw new NoSuchGroupUserException(sb.toString());
	}
	...
	public int countByGroup_Language(long groupId, String language) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_GROUPUSER_WHERE);
	...
	public List<GroupUser> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_GROUPUSER);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_GROUPUSER);
