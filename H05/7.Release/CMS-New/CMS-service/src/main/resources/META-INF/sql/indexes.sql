create index IX_EBCF9F29 on soft_cms_Article (friendlyURL[$COLUMN_LENGTH:4000$], status);
...
create index IX_7F4BC361 on soft_cms_ArticleConfig (uuid_[$COLUMN_LENGTH:75$]);
