...
import com.web.ecoit.portal.quangcao.service.QuangCaoLocalService;
...
/**
 * Provides the base implementation for the quang cao local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.web.ecoit.portal.quangcao.service.impl.QuangCaoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.web.ecoit.portal.quangcao.service.impl.QuangCaoLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class QuangCaoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements QuangCaoLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuangCaoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.web.ecoit.portal.quangcao.service.QuangCaoLocalServiceUtil</code>.
	 */
	...
	public QuangCao addQuangCao(QuangCao quangCao) {
		...
		return quangCaoPersistence.update(quangCao);
	}
	...
	public QuangCao createQuangCao(long quangCaoId) {
		return quangCaoPersistence.create(quangCaoId);
	}
	...
	public QuangCao deleteQuangCao(long quangCaoId) throws PortalException {
		return quangCaoPersistence.remove(quangCaoId);
	}
	...
	public QuangCao deleteQuangCao(QuangCao quangCao) {
		return quangCaoPersistence.remove(quangCao);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QuangCao.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return quangCaoPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return quangCaoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return quangCaoPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public QuangCao fetchQuangCao(long quangCaoId) {
		return quangCaoPersistence.fetchByPrimaryKey(quangCaoId);
	}
	...
	public QuangCao fetchQuangCaoByUuidAndGroupId(String uuid, long groupId) {
		return quangCaoPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public QuangCao getQuangCao(long quangCaoId) throws PortalException {
		return quangCaoPersistence.findByPrimaryKey(quangCaoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(quangCaoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(QuangCao.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("quangCaoId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(QuangCao.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("quangCaoId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return quangCaoLocalService.deleteQuangCao((QuangCao)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return quangCaoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public QuangCao getQuangCaoByUuidAndGroupId(String uuid, long groupId)
		...
		return quangCaoPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuangCaoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		quangCaoLocalService = (QuangCaoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuangCaoLocalService.class.getName();
	}
