...
import com.web.ecoit.portal.quangcao.model.impl.QuangCaoModelImpl;
...
public class QuangCaoPersistenceImpl
	...
	public List<QuangCao> findByUuid(
		...
		List<QuangCao> list = (List<QuangCao>)finderCache.getResult(
	...
	public QuangCao fetchBybyQuangCaoIdAndGroupIdAndType(
		...
		return fetchBybyQuangCaoIdAndGroupIdAndType(quangCaoId, groupId, type);
	}
	...
	public QuangCao fetchBybyQuangCaoIdAndGroupIdAndType(
		...
		Object result = finderCache.getResult(
			_finderPathFetchBybyQuangCaoIdAndGroupIdAndType, finderArgs, this);
	...
	public QuangCao fetchBybyQuangCaoIdAndStatus(
		...
		return fetchBybyQuangCaoIdAndStatus(quangCaoId, status);
	}
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.web.ecoit.portal.quangcao.model.QuangCao"),
			true);
	}
