...
export class PermissionService {
    ...
    getAllPermission(start: number, pageSize:number, searchKey: string ){
        let url = Constants.baseUrl+ '/o/lichcongtac/app/permission/getall/'+ Constants.scopeGroupId + '/' + Constants.userId + '/' + Constants.languageId +'?limit='+pageSize+'&start='+start+'&q='+searchKey;
        return this.httpClient.get(url).pipe(catchError(this.handleError));
    }

    updateViewPermission(id: any): Observable<any>{
        let url = Constants.baseUrl+ '/o/lichcongtac/app/permission/update/view/' + Constants.userId + '/' + Constants.scopeGroupId +'/'+ Constants.languageId + '/' + Constants.companyId + '/' + id;
        return this.httpClient.get(url).pipe(catchError(this.handleError));
    }
    ...
    savePermission(permissionObject: PermissionObject, permissionGroupId: number) {
        ...
        let body = JSON.stringify({
            ...
            columns: permissionObject.columns
        });

        if (permissionGroupId) {
            let updateUrl = Constants.baseUrl + '/o/lichcongtac/app/permission/update/' + Constants.userId + '/' + Constants.scopeGroupId + '/' + permissionGroupId;
            return this.httpClient.put(updateUrl, body, {headers: headers}).pipe(catchError(this.handleError));
        }

        console.log(body);
        let createUrl = Constants.baseUrl + '/o/lichcongtac/app/permission/create/' + Constants.userId + '/'  + Constants.scopeGroupId;
    ...
    deletePermissionGroup(groupUserIdList: number[]) {
        ...
        let deleteUrl = Constants.baseUrl + '/o/lichcongtac/app/permission/delete/' + Constants.userId;
