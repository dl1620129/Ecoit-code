 ...
 * @generated
 */
public class UserGroupRelPK
	implements Comparable<UserGroupRelPK>, Serializable {
	...
	public UserGroupRelPK(long userId, long userPermissionGroupId) {
		this.userId = userId;
	...
	@Override
	public int compareTo(UserGroupRelPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof UserGroupRelPK)) {
			return false;
		}

		UserGroupRelPK pk = (UserGroupRelPK)obj;
