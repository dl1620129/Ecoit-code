...
/**
 * Provides the local service interface for PermissionGroupRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PermissionGroupRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PermissionGroupRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PermissionGroupRelLocalServiceUtil} to access the permission group rel local service. Add custom service methods to <code>com.ecoit.lichcongtac.services.service.impl.PermissionGroupRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
