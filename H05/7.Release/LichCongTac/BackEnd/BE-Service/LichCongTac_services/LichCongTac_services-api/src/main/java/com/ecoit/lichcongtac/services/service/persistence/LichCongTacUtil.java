...
/**
 * The persistence utility for the lich cong tac service. This utility wraps <code>com.ecoit.lichcongtac.services.service.persistence.impl.LichCongTacPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class LichCongTacUtil {
	 ...
	 */
	public static void clearCache(LichCongTac lichCongTac) {
		getPersistence().clearCache(lichCongTac);
	}
	 ...
	 */
	public static Map<Serializable, LichCongTac> fetchByPrimaryKeys(
	 ...
	 */
	public static List<LichCongTac> findWithDynamicQuery(
	 ...
	 */
	public static LichCongTac update(LichCongTac lichCongTac) {
		return getPersistence().update(lichCongTac);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static LichCongTac update(
		LichCongTac lichCongTac, ServiceContext serviceContext) {

		return getPersistence().update(lichCongTac, serviceContext);
	}
	 ...
	 */
	public static LichCongTac findBystatusAndId(
			int trangthaiLichCongTac, long lichCongTacId)
		throws com.ecoit.lichcongtac.services.exception.
			NoSuchLichCongTacException {

		return getPersistence().findBystatusAndId(
	 ...
	 */
	public static LichCongTac fetchBystatusAndId(
		int trangthaiLichCongTac, long lichCongTacId) {

		return getPersistence().fetchBystatusAndId(
			trangthaiLichCongTac, lichCongTacId);
	}
	...
	public static LichCongTac fetchBystatusAndId(
		...
		return getPersistence().fetchBystatusAndId(
			trangthaiLichCongTac, lichCongTacId, useFinderCache);
	}
	 ...
	 */
	public static LichCongTac removeBystatusAndId(
			int trangthaiLichCongTac, long lichCongTacId)
		throws com.ecoit.lichcongtac.services.exception.
			NoSuchLichCongTacException {

		return getPersistence().removeBystatusAndId(
			trangthaiLichCongTac, lichCongTacId);
	}
	 ...
	 */
	public static int countBystatusAndId(
		int trangthaiLichCongTac, long lichCongTacId) {

		return getPersistence().countBystatusAndId(
			trangthaiLichCongTac, lichCongTacId);
	}
	 ...
	 */
	public static List<LichCongTac> findByorganization(long organizationId) {
	 ...
	 */
	public static List<LichCongTac> findByorganization(
	 ...
	 * @throws NoSuchLichCongTacException if a matching lich cong tac could not be found
	 */
	public static LichCongTac findByorganization_First(
			long organizationId,
			OrderByComparator<LichCongTac> orderByComparator)
		throws com.ecoit.lichcongtac.services.exception.
			NoSuchLichCongTacException {
	 ...
	 */
	public static LichCongTac fetchByorganization_First(
	 ...
	 * @throws NoSuchLichCongTacException if a matching lich cong tac could not be found
	 */
	public static LichCongTac findByorganization_Last(
			long organizationId,
			OrderByComparator<LichCongTac> orderByComparator)
		throws com.ecoit.lichcongtac.services.exception.
			NoSuchLichCongTacException {
	 ...
	 */
	public static LichCongTac fetchByorganization_Last(
		long organizationId, OrderByComparator<LichCongTac> orderByComparator) {
	 ...
	 */
	public static LichCongTac[] findByorganization_PrevAndNext(
		...
		return getPersistence().findByorganization_PrevAndNext(
			lichCongTacId, organizationId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(LichCongTac lichCongTac) {
		getPersistence().cacheResult(lichCongTac);
	}
	 ...
	 */
	public static void cacheResult(List<LichCongTac> lichCongTacs) {
		getPersistence().cacheResult(lichCongTacs);
	}
	 ...
	 */
	public static LichCongTac create(long lichCongTacId) {
	 ...
	 * @throws NoSuchLichCongTacException if a lich cong tac with the primary key could not be found
	 */
	public static LichCongTac remove(long lichCongTacId)
		throws com.ecoit.lichcongtac.services.exception.
			NoSuchLichCongTacException {
	...
	public static LichCongTac updateImpl(LichCongTac lichCongTac) {
		return getPersistence().updateImpl(lichCongTac);
	}
	 ...
	 * @throws NoSuchLichCongTacException if a lich cong tac with the primary key could not be found
	 */
	public static LichCongTac findByPrimaryKey(long lichCongTacId)
		throws com.ecoit.lichcongtac.services.exception.
			NoSuchLichCongTacException {
	 ...
	 */
	public static LichCongTac fetchByPrimaryKey(long lichCongTacId) {
	 ...
	 */
	public static List<LichCongTac> findAll() {
	 ...
	 */
	public static List<LichCongTac> findAll(int start, int end) {
	...
	public static LichCongTacPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker
		<LichCongTacPersistence, LichCongTacPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LichCongTacPersistence.class);

		ServiceTracker<LichCongTacPersistence, LichCongTacPersistence>
			serviceTracker =
				new ServiceTracker
					<LichCongTacPersistence, LichCongTacPersistence>(
						bundle.getBundleContext(), LichCongTacPersistence.class,
						null);
