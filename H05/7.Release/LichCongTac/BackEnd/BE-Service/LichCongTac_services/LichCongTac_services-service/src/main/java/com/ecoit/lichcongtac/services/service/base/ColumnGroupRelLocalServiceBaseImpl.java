...
import com.ecoit.lichcongtac.services.service.ColumnGroupRelLocalService;
...
/**
 * Provides the base implementation for the column group rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.lichcongtac.services.service.impl.ColumnGroupRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ecoit.lichcongtac.services.service.impl.ColumnGroupRelLocalServiceImpl
 * @generated
 */
public abstract class ColumnGroupRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, ColumnGroupRelLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ColumnGroupRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.lichcongtac.services.service.ColumnGroupRelLocalServiceUtil</code>.
	 */
	...
	public ColumnGroupRel addColumnGroupRel(ColumnGroupRel columnGroupRel) {
		...
		return columnGroupRelPersistence.update(columnGroupRel);
	}
	...
	public ColumnGroupRel createColumnGroupRel(
		...
		return columnGroupRelPersistence.create(columnGroupRelPK);
	}
	...
	public ColumnGroupRel deleteColumnGroupRel(
		...
		return columnGroupRelPersistence.remove(columnGroupRelPK);
	}
	...
	public ColumnGroupRel deleteColumnGroupRel(ColumnGroupRel columnGroupRel) {
		return columnGroupRelPersistence.remove(columnGroupRel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ColumnGroupRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return columnGroupRelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return columnGroupRelPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return columnGroupRelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return columnGroupRelPersistence.countWithDynamicQuery(
	...
	public ColumnGroupRel fetchColumnGroupRel(
		...
		return columnGroupRelPersistence.fetchByPrimaryKey(columnGroupRelPK);
	}
	...
	public ColumnGroupRel getColumnGroupRel(ColumnGroupRelPK columnGroupRelPK)
		...
		return columnGroupRelPersistence.findByPrimaryKey(columnGroupRelPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(columnGroupRelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ColumnGroupRel.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			columnGroupRelLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ColumnGroupRel.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return columnGroupRelLocalService.deleteColumnGroupRel(
			(ColumnGroupRel)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return columnGroupRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ColumnGroupRel> getColumnGroupRels(int start, int end) {
		return columnGroupRelPersistence.findAll(start, end);
	}
	...
	public int getColumnGroupRelsCount() {
		return columnGroupRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ColumnGroupRelLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		columnGroupRelLocalService = (ColumnGroupRelLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ColumnGroupRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = columnGroupRelPersistence.getDataSource();
	...
	protected ColumnGroupRelLocalService columnGroupRelLocalService;
