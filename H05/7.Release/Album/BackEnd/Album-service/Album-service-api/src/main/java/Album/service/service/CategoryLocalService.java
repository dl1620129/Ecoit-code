...
public interface CategoryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CategoryLocalServiceUtil} to access the category local service. Add custom service methods to <code>Album.service.service.impl.CategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
