...
/**
 * Provides the local service interface for Fields. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FieldsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FieldsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FieldsLocalServiceUtil} to access the fields local service. Add custom service methods to <code>Album.service.service.impl.FieldsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
