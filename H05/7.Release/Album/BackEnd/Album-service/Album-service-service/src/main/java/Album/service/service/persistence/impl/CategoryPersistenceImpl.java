...
import Album.service.model.impl.CategoryModelImpl;
...
public class CategoryPersistenceImpl
	 ...
	 */
	@Override
	public List<Category> findByFindAll(long groupId, long companyId) {
	 ...
	 */
	@Override
	public List<Category> findByFindAll(
	...
	public Category findByFindAll_First(
		...
		Category category = fetchByFindAll_First(
	...
	public Category fetchByFindAll_First(
		...
		List<Category> list = findByFindAll(
	...
	public Category findByFindAll_Last(
		...
		Category category = fetchByFindAll_Last(
			groupId, companyId, orderByComparator);
	...
	protected Category getByFindAll_PrevAndNext(
	...
	private FinderPath _finderPathWithPaginationFindByFindStatus;
	private FinderPath _finderPathWithoutPaginationFindByFindStatus;
	private FinderPath _finderPathCountByFindStatus;
	 ...
	 */
	@Override
	public List<Category> findByFindStatus(long status) {
		return findByFindStatus(
	 ...
	 */
	@Override
	public List<Category> findByFindStatus(long status, int start, int end) {
		return findByFindStatus(status, start, end, null);
	}
	...
	@Deprecated
	@Override
	public List<Category> findByFindStatus(
		long status, int start, int end,
		OrderByComparator<Category> orderByComparator, boolean useFinderCache) {

		return findByFindStatus(status, start, end, orderByComparator);
	}
	...
	public List<Category> findByFindStatus(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = _finderPathWithoutPaginationFindByFindStatus;
			finderArgs = new Object[] {status};
		}
		else {
			finderPath = _finderPathWithPaginationFindByFindStatus;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_FINDSTATUS_STATUS_2);
	...
	public Category findByFindStatus_First(
		...
		Category category = fetchByFindStatus_First(status, orderByComparator);
	...
	public Category fetchByFindStatus_First(
		...
		List<Category> list = findByFindStatus(status, 0, 1, orderByComparator);
	...
	public Category findByFindStatus_Last(
		...
		Category category = fetchByFindStatus_Last(status, orderByComparator);
	...
	public Category fetchByFindStatus_Last(
		...
		int count = countByFindStatus(status);

		if (count == 0) {
			return null;
		}

		List<Category> list = findByFindStatus(
	...
	public Category[] findByFindStatus_PrevAndNext(
		...
		try {
			...
			array[0] = getByFindStatus_PrevAndNext(
				session, category, status, orderByComparator, true);

			array[1] = category;

			array[2] = getByFindStatus_PrevAndNext(
				session, category, status, orderByComparator, false);
	...
	protected Category getByFindStatus_PrevAndNext(
		Session session, Category category, long status,
		OrderByComparator<Category> orderByComparator, boolean previous) {
	...
	public int countByFindStatus(long status) {
		FinderPath finderPath = _finderPathCountByFindStatus;
	...
	private static final String _FINDER_COLUMN_FINDSTATUS_STATUS_2 =
		"category.status = ?";
	...
	public Category updateImpl(Category category) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {categoryModelImpl.getStatus()};

			finderCache.removeResult(_finderPathCountByFindStatus, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByFindStatus, args);
			...
			if ((categoryModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByFindStatus.
					 getColumnBitmask()) != 0) {

				Object[] args = new Object[] {
					categoryModelImpl.getOriginalStatus()
				};
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByFindStatus = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, CategoryImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByFindStatus",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			});

		_finderPathWithoutPaginationFindByFindStatus = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, CategoryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByFindStatus",
			new String[] {Long.class.getName()},
			CategoryModelImpl.STATUS_COLUMN_BITMASK |
			CategoryModelImpl.NAME_COLUMN_BITMASK);

		_finderPathCountByFindStatus = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByFindStatus",
			new String[] {Long.class.getName()});
	}
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.Album.service.model.Category"),
			true);
	}
