...
/**
 * Provides the local service interface for UserOrganization. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserOrganizationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserOrganizationLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserOrganizationLocalServiceUtil} to access the user organization local service. Add custom service methods to <code>organizationalStructure.service.service.impl.UserOrganizationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public UserOrganization deleteUserOrganization(
		UserOrganization userOrganization);
