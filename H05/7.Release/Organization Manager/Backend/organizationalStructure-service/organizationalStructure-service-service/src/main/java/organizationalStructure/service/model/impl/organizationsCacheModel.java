 ...
 */
@ProviderType
public class organizationsCacheModel
	implements CacheModel<organizations>, Externalizable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof organizationsCacheModel)) {
			return false;
		}

		organizationsCacheModel organizationsCacheModel =
			(organizationsCacheModel)obj;

		if (organizationId == organizationsCacheModel.organizationId) {
			return true;
		}
	...
	public organizations toEntityModel() {
		...
		if (uuid == null) {
			organizationsImpl.setUuid("");
		}
		else {
			organizationsImpl.setUuid(uuid);
		}

		organizationsImpl.setOrganizationId(organizationId);

		if (organizationCode == null) {
			organizationsImpl.setOrganizationCode("");
		}
		else {
			organizationsImpl.setOrganizationCode(organizationCode);
		}

		organizationsImpl.setGroupId(groupId);

		if (name == null) {
			organizationsImpl.setName("");
		}
		else {
			organizationsImpl.setName(name);
		}

		if (description == null) {
			organizationsImpl.setDescription("");
		}
		else {
			organizationsImpl.setDescription(description);
		}

		if (leader == null) {
			organizationsImpl.setLeader("");
		}
		else {
			organizationsImpl.setLeader(leader);
		}

		organizationsImpl.setMember(member);

		if (address == null) {
			organizationsImpl.setAddress("");
		}
		else {
			organizationsImpl.setAddress(address);
		}

		if (phoneNumber == null) {
			organizationsImpl.setPhoneNumber("");
		}
		else {
			organizationsImpl.setPhoneNumber(phoneNumber);
		}

		if (position == null) {
			organizationsImpl.setPosition("");
		}
		else {
			organizationsImpl.setPosition(position);
		}

		organizationsImpl.setParentId(parentId);
		...
		organizationsImpl.setCreateUser(createUser);
		organizationsImpl.setModifiedUser(modifiedUser);
		organizationsImpl.setStatus(status);
		organizationsImpl.setThuTu(thuTu);
