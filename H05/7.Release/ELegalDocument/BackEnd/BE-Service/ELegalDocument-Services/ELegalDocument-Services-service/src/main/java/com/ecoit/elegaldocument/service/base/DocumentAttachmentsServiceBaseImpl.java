...
import com.ecoit.elegaldocument.service.DocumentAttachmentsService;
...
/**
 * Provides the base implementation for the document attachments remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.DocumentAttachmentsServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.DocumentAttachmentsServiceImpl
 * @generated
 */
public abstract class DocumentAttachmentsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DocumentAttachmentsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DocumentAttachmentsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.DocumentAttachmentsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DocumentAttachmentsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		documentAttachmentsService = (DocumentAttachmentsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DocumentAttachmentsService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.DocumentAttachmentsLocalService
