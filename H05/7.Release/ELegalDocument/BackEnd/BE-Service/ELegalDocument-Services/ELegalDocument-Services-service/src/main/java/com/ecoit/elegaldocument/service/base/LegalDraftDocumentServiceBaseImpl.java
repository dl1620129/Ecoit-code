...
import com.ecoit.elegaldocument.service.LegalDraftDocumentService;
...
/**
 * Provides the base implementation for the legal draft document remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalDraftDocumentServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalDraftDocumentServiceImpl
 * @generated
 */
public abstract class LegalDraftDocumentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LegalDraftDocumentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalDraftDocumentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalDraftDocumentServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalDraftDocumentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalDraftDocumentService = (LegalDraftDocumentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalDraftDocumentService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalDraftDocumentLocalService
		legalDraftDocumentLocalService;

	protected LegalDraftDocumentService legalDraftDocumentService;
