...
import com.ecoit.elegaldocument.service.GroupOrganizationService;
...
/**
 * Provides the base implementation for the group organization remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.GroupOrganizationServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.GroupOrganizationServiceImpl
 * @generated
 */
public abstract class GroupOrganizationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GroupOrganizationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GroupOrganizationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.GroupOrganizationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GroupOrganizationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		groupOrganizationService = (GroupOrganizationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GroupOrganizationService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.GroupOrganizationLocalService
		groupOrganizationLocalService;

	protected GroupOrganizationService groupOrganizationService;
