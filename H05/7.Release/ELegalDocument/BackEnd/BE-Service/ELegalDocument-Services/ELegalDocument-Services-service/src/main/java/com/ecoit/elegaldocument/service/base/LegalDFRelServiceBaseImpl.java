...
import com.ecoit.elegaldocument.service.LegalDFRelService;
...
/**
 * Provides the base implementation for the legal df rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalDFRelServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalDFRelServiceImpl
 * @generated
 */
public abstract class LegalDFRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LegalDFRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalDFRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalDFRelServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalDFRelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalDFRelService = (LegalDFRelService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalDFRelService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalDFRelLocalService
		legalDFRelLocalService;

	protected LegalDFRelService legalDFRelService;
