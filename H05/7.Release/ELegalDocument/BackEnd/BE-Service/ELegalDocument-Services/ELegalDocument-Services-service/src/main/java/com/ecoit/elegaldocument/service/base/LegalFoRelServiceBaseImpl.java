...
import com.ecoit.elegaldocument.service.LegalFoRelService;
...
/**
 * Provides the base implementation for the legal fo rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalFoRelServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalFoRelServiceImpl
 * @generated
 */
public abstract class LegalFoRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LegalFoRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalFoRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalFoRelServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalFoRelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalFoRelService = (LegalFoRelService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalFoRelService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalFoRelLocalService
		legalFoRelLocalService;

	protected LegalFoRelService legalFoRelService;
