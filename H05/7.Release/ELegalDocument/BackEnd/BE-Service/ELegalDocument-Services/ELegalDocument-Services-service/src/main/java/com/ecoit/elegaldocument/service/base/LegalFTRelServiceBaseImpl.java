...
import com.ecoit.elegaldocument.service.LegalFTRelService;
...
/**
 * Provides the base implementation for the legal ft rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalFTRelServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalFTRelServiceImpl
 * @generated
 */
public abstract class LegalFTRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LegalFTRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalFTRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalFTRelServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalFTRelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalFTRelService = (LegalFTRelService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalFTRelService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalFTRelLocalService
		legalFTRelLocalService;

	protected LegalFTRelService legalFTRelService;
