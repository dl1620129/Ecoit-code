...
import com.ecoit.elegaldocument.service.LegalTypeService;
...
/**
 * Provides the base implementation for the legal type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalTypeServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalTypeServiceImpl
 * @generated
 */
public abstract class LegalTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LegalTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalTypeServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalTypeService = (LegalTypeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalTypeService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalTypeLocalService
		legalTypeLocalService;

	protected LegalTypeService legalTypeService;
