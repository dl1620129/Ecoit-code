...
import com.ecoit.elegaldocument.service.LegalLoggerService;
...
/**
 * Provides the base implementation for the legal logger remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalLoggerServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalLoggerServiceImpl
 * @generated
 */
public abstract class LegalLoggerServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LegalLoggerService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalLoggerService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalLoggerServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalLoggerService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalLoggerService = (LegalLoggerService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalLoggerService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalLoggerLocalService
		legalLoggerLocalService;

	protected LegalLoggerService legalLoggerService;
