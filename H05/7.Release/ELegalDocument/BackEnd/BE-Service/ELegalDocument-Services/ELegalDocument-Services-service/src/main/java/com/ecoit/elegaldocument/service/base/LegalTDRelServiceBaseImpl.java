...
import com.ecoit.elegaldocument.service.LegalTDRelService;
...
/**
 * Provides the base implementation for the legal td rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalTDRelServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalTDRelServiceImpl
 * @generated
 */
public abstract class LegalTDRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LegalTDRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalTDRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalTDRelServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalTDRelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalTDRelService = (LegalTDRelService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalTDRelService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalTDRelLocalService
		legalTDRelLocalService;

	protected LegalTDRelService legalTDRelService;
