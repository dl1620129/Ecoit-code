...
import com.ecoit.elegaldocument.service.LegalFTRelLocalService;
...
/**
 * Provides the base implementation for the legal ft rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalFTRelLocalServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalFTRelLocalServiceImpl
 * @generated
 */
public abstract class LegalFTRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LegalFTRelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalFTRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalFTRelLocalServiceUtil</code>.
	 */
	...
	public LegalFTRel addLegalFTRel(LegalFTRel legalFTRel) {
		...
		return legalFTRelPersistence.update(legalFTRel);
	}
	...
	public LegalFTRel createLegalFTRel(LegalFTRelPK legalFTRelPK) {
		return legalFTRelPersistence.create(legalFTRelPK);
	}
	...
	public LegalFTRel deleteLegalFTRel(LegalFTRelPK legalFTRelPK)
		...
		return legalFTRelPersistence.remove(legalFTRelPK);
	}
	...
	public LegalFTRel deleteLegalFTRel(LegalFTRel legalFTRel) {
		return legalFTRelPersistence.remove(legalFTRel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LegalFTRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return legalFTRelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return legalFTRelPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return legalFTRelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return legalFTRelPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LegalFTRel fetchLegalFTRel(LegalFTRelPK legalFTRelPK) {
		return legalFTRelPersistence.fetchByPrimaryKey(legalFTRelPK);
	}
	...
	public LegalFTRel getLegalFTRel(LegalFTRelPK legalFTRelPK)
		...
		return legalFTRelPersistence.findByPrimaryKey(legalFTRelPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(legalFTRelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LegalFTRel.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			legalFTRelLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LegalFTRel.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return legalFTRelLocalService.deleteLegalFTRel(
			(LegalFTRel)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return legalFTRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LegalFTRel> getLegalFTRels(int start, int end) {
		return legalFTRelPersistence.findAll(start, end);
	}
	...
	public int getLegalFTRelsCount() {
		return legalFTRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalFTRelLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		legalFTRelLocalService = (LegalFTRelLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalFTRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = legalFTRelPersistence.getDataSource();
	...
	protected LegalFTRelLocalService legalFTRelLocalService;
