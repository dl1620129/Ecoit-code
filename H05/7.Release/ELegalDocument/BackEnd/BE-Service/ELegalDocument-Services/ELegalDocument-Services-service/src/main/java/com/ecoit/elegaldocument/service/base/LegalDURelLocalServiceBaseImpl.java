...
import com.ecoit.elegaldocument.service.LegalDURelLocalService;
...
/**
 * Provides the base implementation for the legal du rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalDURelLocalServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalDURelLocalServiceImpl
 * @generated
 */
public abstract class LegalDURelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LegalDURelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalDURelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalDURelLocalServiceUtil</code>.
	 */
	...
	public LegalDURel addLegalDURel(LegalDURel legalDURel) {
		...
		return legalDURelPersistence.update(legalDURel);
	}
	...
	public LegalDURel createLegalDURel(LegalDURelPK legalDURelPK) {
		return legalDURelPersistence.create(legalDURelPK);
	}
	...
	public LegalDURel deleteLegalDURel(LegalDURelPK legalDURelPK)
		...
		return legalDURelPersistence.remove(legalDURelPK);
	}
	...
	public LegalDURel deleteLegalDURel(LegalDURel legalDURel) {
		return legalDURelPersistence.remove(legalDURel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LegalDURel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return legalDURelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return legalDURelPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return legalDURelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return legalDURelPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LegalDURel fetchLegalDURel(LegalDURelPK legalDURelPK) {
		return legalDURelPersistence.fetchByPrimaryKey(legalDURelPK);
	}
	...
	public LegalDURel getLegalDURel(LegalDURelPK legalDURelPK)
		...
		return legalDURelPersistence.findByPrimaryKey(legalDURelPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(legalDURelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LegalDURel.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			legalDURelLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LegalDURel.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return legalDURelLocalService.deleteLegalDURel(
			(LegalDURel)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return legalDURelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LegalDURel> getLegalDURels(int start, int end) {
		return legalDURelPersistence.findAll(start, end);
	}
	...
	public int getLegalDURelsCount() {
		return legalDURelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalDURelLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		legalDURelLocalService = (LegalDURelLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalDURelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = legalDURelPersistence.getDataSource();
	...
	protected LegalDURelLocalService legalDURelLocalService;
