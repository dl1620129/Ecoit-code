...
import com.ecoit.elegaldocument.service.LegalOrgLocalService;
...
/**
 * Provides the base implementation for the legal org local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalOrgLocalServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalOrgLocalServiceImpl
 * @generated
 */
public abstract class LegalOrgLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LegalOrgLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalOrgLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalOrgLocalServiceUtil</code>.
	 */
	...
	public LegalOrg addLegalOrg(LegalOrg legalOrg) {
		...
		return legalOrgPersistence.update(legalOrg);
	}
	...
	public LegalOrg createLegalOrg(long organizationId) {
		return legalOrgPersistence.create(organizationId);
	}
	...
	public LegalOrg deleteLegalOrg(long organizationId) throws PortalException {
		return legalOrgPersistence.remove(organizationId);
	}
	...
	public LegalOrg deleteLegalOrg(LegalOrg legalOrg) {
		return legalOrgPersistence.remove(legalOrg);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LegalOrg.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return legalOrgPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return legalOrgPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return legalOrgPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return legalOrgPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LegalOrg fetchLegalOrg(long organizationId) {
		return legalOrgPersistence.fetchByPrimaryKey(organizationId);
	}
	...
	public LegalOrg getLegalOrg(long organizationId) throws PortalException {
		return legalOrgPersistence.findByPrimaryKey(organizationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(legalOrgLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LegalOrg.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(LegalOrg.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return legalOrgLocalService.deleteLegalOrg((LegalOrg)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return legalOrgPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LegalOrg> getLegalOrgs(int start, int end) {
		return legalOrgPersistence.findAll(start, end);
	}
	...
	public int getLegalOrgsCount() {
		return legalOrgPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalOrgLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		legalOrgLocalService = (LegalOrgLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalOrgLocalService.class.getName();
	}
	...
	protected LegalOrgLocalService legalOrgLocalService;
