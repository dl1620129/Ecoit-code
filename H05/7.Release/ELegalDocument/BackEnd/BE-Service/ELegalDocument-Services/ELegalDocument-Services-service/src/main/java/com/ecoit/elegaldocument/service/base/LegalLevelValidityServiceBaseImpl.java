...
import com.ecoit.elegaldocument.service.LegalLevelValidityService;
...
/**
 * Provides the base implementation for the legal level validity remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalLevelValidityServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalLevelValidityServiceImpl
 * @generated
 */
public abstract class LegalLevelValidityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LegalLevelValidityService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalLevelValidityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalLevelValidityServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalLevelValidityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalLevelValidityService = (LegalLevelValidityService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalLevelValidityService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalLevelValidityLocalService
		legalLevelValidityLocalService;

	protected LegalLevelValidityService legalLevelValidityService;
