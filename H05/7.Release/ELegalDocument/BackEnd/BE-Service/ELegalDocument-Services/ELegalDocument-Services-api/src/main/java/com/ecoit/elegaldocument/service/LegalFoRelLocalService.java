...
/**
 * Provides the local service interface for LegalFoRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalFoRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalFoRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalFoRelLocalServiceUtil} to access the legal fo rel local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalFoRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
