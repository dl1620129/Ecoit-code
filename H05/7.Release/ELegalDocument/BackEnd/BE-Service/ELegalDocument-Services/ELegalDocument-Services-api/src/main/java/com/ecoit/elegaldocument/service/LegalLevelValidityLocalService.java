...
/**
 * Provides the local service interface for LegalLevelValidity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalLevelValidityLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalLevelValidityLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalLevelValidityLocalServiceUtil} to access the legal level validity local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalLevelValidityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LegalLevelValidity> getLegalLevelValidities(int start, int end);
