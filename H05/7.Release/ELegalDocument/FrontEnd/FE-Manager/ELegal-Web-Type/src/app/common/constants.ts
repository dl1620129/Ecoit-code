...
export class Constants {
    ...
    public static DELETE_PARAM_MESSAGE = "Hiện đang có văn bản của lĩnh vực này. Bạn hãy xóa hết văn bản liên quan trước khi xóa lĩnh vực này.";

    public static NOT_ACCESS_MESSAGE = 'Bạn hiện tại không có quyền chỉnh sửa các lĩnh vực văn bản.';
