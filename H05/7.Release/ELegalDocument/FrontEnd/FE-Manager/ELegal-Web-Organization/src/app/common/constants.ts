...
export class Constants {
    ...
    public static DELETE_PARAM_MESSAGE = "Hiện đang có văn bản với tổ chức này. Bạn hãy xóa hết văn bản liên quan trước khi xóa tổ chức này.";

    public static NOT_ACCESS_MESSAGE = 'Bạn hiện tại không có quyền chỉnh sửa các cơ quan ban hành.';
