...
export class Constants {
    ...
    public static VAN_BAN_MOI_NHAT = 0;

    public static VAN_BAN_DIEU_HANH = 1;

    public static VAN_BAN_PHAP_QUY = 2;

    public static VAN_BAN_HOP_NHAT = 3;

    public static CONFIGURATION = 0;
}