...
/**
 * Provides the local service interface for members. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see membersLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface membersLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link membersLocalServiceUtil} to access the members local service. Add custom service methods to <code>organizationalStructure.service.service.impl.membersLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
