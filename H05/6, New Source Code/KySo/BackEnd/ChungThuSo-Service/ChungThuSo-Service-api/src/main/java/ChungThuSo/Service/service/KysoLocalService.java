...
/**
 * Provides the local service interface for Kyso. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see KysoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface KysoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KysoLocalServiceUtil} to access the kyso local service. Add custom service methods to <code>ChungThuSo.Service.service.impl.KysoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
