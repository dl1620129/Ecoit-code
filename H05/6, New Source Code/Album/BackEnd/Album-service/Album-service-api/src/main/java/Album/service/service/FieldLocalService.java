...
public interface FieldLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FieldLocalServiceUtil} to access the field local service. Add custom service methods to <code>Album.service.service.impl.FieldLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Field deleteField(long fieldId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Field fetchField(long fieldId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Field getField(long fieldId) throws PortalException;
