...
@Component({
    ...
    templateUrl: 
		...
		'/o/MemberReport-Permission/app/permission-list.component.html'
})
...
export class PermissionListComponent implements OnInit {
    ...
    constructor( public service: PermissionService ,public router: Router, 
        ...
        private notifierService: NotifierService,private  dropdownConfig:NgbDropdownConfig) { 
    ...
    deletePermission(id: number) {
        this.service.deletePermissionGroup(id).subscribe((response: any) => {
            if (response.error_code == Constants.SUCCESSFUL_CODE) {
