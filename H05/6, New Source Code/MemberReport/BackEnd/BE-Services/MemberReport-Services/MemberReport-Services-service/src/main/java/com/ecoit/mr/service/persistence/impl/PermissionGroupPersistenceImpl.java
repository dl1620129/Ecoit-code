...
import com.ecoit.mr.model.impl.PermissionGroupModelImpl;
...
public class PermissionGroupPersistenceImpl
	 ...
	 */
	@Override
	public List<PermissionGroup> findByGroup(long userPermissionGroupId) {
		return findByGroup(
	 ...
	 */
	@Override
	public List<PermissionGroup> findByGroup(
			...
			if ((list != null) && !list.isEmpty()) {
				for (PermissionGroup permissionGroup : list) {
					if (userPermissionGroupId !=
							permissionGroup.getUserPermissionGroupId()) {
	...
	public PermissionGroup findByGroup_First(
		...
		PermissionGroup permissionGroup = fetchByGroup_First(
	...
	public PermissionGroup fetchByGroup_First(
		...
		List<PermissionGroup> list = findByGroup(
	...
	public PermissionGroup findByGroup_Last(
		...
		PermissionGroup permissionGroup = fetchByGroup_Last(
			userPermissionGroupId, orderByComparator);
	...
	public PermissionGroup[] findByGroup_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroup_PrevAndNext(
				session, permissionGroup, userPermissionGroupId,
	...
	protected PermissionGroup getByGroup_PrevAndNext(
		Session session, PermissionGroup permissionGroup,
		long userPermissionGroupId,
		OrderByComparator<PermissionGroup> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_GROUP_USERPERMISSIONGROUPID_2 =
		"permissionGroup.id.userPermissionGroupId = ?";
	...
	public PermissionGroup updateImpl(PermissionGroup permissionGroup) {
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {
				permissionGroupModelImpl.getUserPermissionGroupId()
			};
			...
			if ((permissionGroupModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					permissionGroupModelImpl.getOriginalUserPermissionGroupId()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByGroup = new FinderPath(
			...
			PermissionGroupModelImpl.USERPERMISSIONGROUPID_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.ecoit.mr.model.PermissionGroup"),
			true);
	}
