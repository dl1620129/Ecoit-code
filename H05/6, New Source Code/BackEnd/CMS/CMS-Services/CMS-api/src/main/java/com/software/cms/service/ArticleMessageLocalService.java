...
/**
 * Provides the local service interface for ArticleMessage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author DungNV
 * @see ArticleMessageLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ArticleMessageLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ArticleMessageLocalServiceUtil} to access the article message local service. Add custom service methods to <code>com.software.cms.service.impl.ArticleMessageLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
