...
public class ArticleWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("humanAccess", getHumanAccess());
		attributes.put("humanAccessIds", getHumanAccessIds());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String humanAccess = (String)attributes.get("humanAccess");

		if (humanAccess != null) {
			setHumanAccess(humanAccess);
		}

		String humanAccessIds = (String)attributes.get("humanAccessIds");

		if (humanAccessIds != null) {
			setHumanAccessIds(humanAccessIds);
		}
	}
	...
	/**
	 * Returns the human access of this article.
	 *
	 * @return the human access of this article
	 */
	@Override
	public String getHumanAccess() {
		return model.getHumanAccess();
	}

	/**
	 * Returns the human access IDs of this article.
	 *
	 * @return the human access IDs of this article
	 */
	@Override
	public String getHumanAccessIds() {
		return model.getHumanAccessIds();
	}
	...
	/**
	 * Sets the human access of this article.
	 *
	 * @param humanAccess the human access of this article
	 */
	@Override
	public void setHumanAccess(String humanAccess) {
		model.setHumanAccess(humanAccess);
	}

	/**
	 * Sets the human access IDs of this article.
	 *
	 * @param humanAccessIds the human access IDs of this article
	 */
	@Override
	public void setHumanAccessIds(String humanAccessIds) {
		model.setHumanAccessIds(humanAccessIds);
	}
