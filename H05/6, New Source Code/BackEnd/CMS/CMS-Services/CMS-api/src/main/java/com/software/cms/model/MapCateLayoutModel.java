...
/**
 * The base model interface for the MapCateLayout service. Represents a row in the &quot;soft_cms_MapCateLayout&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.software.cms.model.impl.MapCateLayoutModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.software.cms.model.impl.MapCateLayoutImpl</code>.
 * </p>
 *
 * @author DungNV
 * @see MapCateLayout
 ...
 */
@ProviderType
public interface MapCateLayoutModel
	extends BaseModel<MapCateLayout>, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a map cate layout model instance should use the {@link MapCateLayout} interface instead.
	 */
