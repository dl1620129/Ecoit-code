...
public class GroupUserUtil {
	 ...
	 */
	public static List<GroupUser> findByGroup_Language(
	 ...
	 */
	public static GroupUser findByGroup_Language_First(
			long groupId, String language,
			OrderByComparator<GroupUser> orderByComparator)
		throws com.software.cms.exception.NoSuchGroupUserException {
	 ...
	 */
	public static GroupUser fetchByGroup_Language_First(
		long groupId, String language,
		OrderByComparator<GroupUser> orderByComparator) {
	 ...
	 * @throws NoSuchGroupUserException if a matching group user could not be found
	 */
	public static GroupUser findByGroup_Language_Last(
			long groupId, String language,
			OrderByComparator<GroupUser> orderByComparator)
		throws com.software.cms.exception.NoSuchGroupUserException {
	 ...
	 */
	public static GroupUser fetchByGroup_Language_Last(
		long groupId, String language,
		OrderByComparator<GroupUser> orderByComparator) {
	 ...
	 */
	public static GroupUser[] findByGroup_Language_PrevAndNext(
			long groupUserId, long groupId, String language,
			OrderByComparator<GroupUser> orderByComparator)
		throws com.software.cms.exception.NoSuchGroupUserException {

		return getPersistence().findByGroup_Language_PrevAndNext(
			groupUserId, groupId, language, orderByComparator);
	}
