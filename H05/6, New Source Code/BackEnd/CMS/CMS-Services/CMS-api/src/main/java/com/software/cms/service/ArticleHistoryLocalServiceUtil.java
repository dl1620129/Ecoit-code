...
public class ArticleHistoryLocalServiceUtil {
	...
	public static int countByArticle(long articleId) throws Exception {
		return getService().countByArticle(articleId);
	}
	...
	public static java.util.List<com.software.cms.model.ArticleHistory>
		...
		return getService().getHistoryFromArticle(articleId, start, end);
	}
