...
public interface ArticleLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Article> getArticleByCate(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Article getArticleByImageId(long articleId, long imageId)
		throws Exception;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Object[]> getArticleSource(String source, int limit)
		throws Exception;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Article> searchNewArticle(
