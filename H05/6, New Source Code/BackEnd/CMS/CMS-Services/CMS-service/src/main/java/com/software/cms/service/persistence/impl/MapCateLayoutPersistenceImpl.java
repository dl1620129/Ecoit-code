...
public class MapCateLayoutPersistenceImpl
	...
	public List<MapCateLayout> findByUuid(
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_MAPCATELAYOUT_WHERE);
			...
			if (orderByComparator != null) {
				...
				query.append(MapCateLayoutModelImpl.ORDER_BY_JPQL);
			}
	...
	public MapCateLayout findByUuid_First(
		...
		throw new NoSuchMapCateLayoutException(msg.toString());
	}
	...
	protected MapCateLayout getByUuid_PrevAndNext(
		...
		List<MapCateLayout> list = q.list();
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_MAPCATELAYOUT_WHERE);
	...
	public MapCateLayout fetchByCategoryIdAndType(
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_CATEGORYIDANDTYPE_CATEGORYID_2);

			query.append(_FINDER_COLUMN_CATEGORYIDANDTYPE_TYPE_2);
	...
	public MapCateLayout fetchByByLayoutIdAndType(
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_BYLAYOUTIDANDTYPE_LAYOUTID_2);

			query.append(_FINDER_COLUMN_BYLAYOUTIDANDTYPE_TYPE_2);
	...
	public List<MapCateLayout> findByCheckCategoryIdAndType(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_CHECKCATEGORYIDANDTYPE_CATEGORYID_2);

			query.append(_FINDER_COLUMN_CHECKCATEGORYIDANDTYPE_TYPE_2);
	...
	public List<MapCateLayout> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_MAPCATELAYOUT);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_MAPCATELAYOUT);
