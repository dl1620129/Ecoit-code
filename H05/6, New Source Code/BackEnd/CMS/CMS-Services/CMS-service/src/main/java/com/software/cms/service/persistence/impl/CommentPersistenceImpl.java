...
public class CommentPersistenceImpl
	...
	public List<Comment> findByGroup_Article(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_GROUP_ARTICLE_GROUPID_2);

			query.append(_FINDER_COLUMN_GROUP_ARTICLE_ARTICLEID_2);
	...
	public List<Comment> findByGroup_Article_Parent(
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_GROUP_ARTICLE_PARENT_GROUPID_2);

			query.append(_FINDER_COLUMN_GROUP_ARTICLE_PARENT_ARTICLEID_2);

			query.append(_FINDER_COLUMN_GROUP_ARTICLE_PARENT_PARENTID_2);
