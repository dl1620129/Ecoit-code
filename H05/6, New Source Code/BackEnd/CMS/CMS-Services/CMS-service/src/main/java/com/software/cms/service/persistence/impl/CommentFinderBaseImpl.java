 ...
 * @generated
 */
public abstract class CommentFinderBaseImpl
	extends BasePersistenceImpl<Comment> {

	public CommentFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return commentPersistence.getBadColumnNames();
	}
