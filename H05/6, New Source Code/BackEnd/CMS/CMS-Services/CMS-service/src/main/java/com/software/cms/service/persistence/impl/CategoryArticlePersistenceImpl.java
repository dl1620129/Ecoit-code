...
public class CategoryArticlePersistenceImpl
	...
	public List<CategoryArticle> findByArticle(
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_CATEGORYARTICLE_WHERE);
			...
			if (orderByComparator != null) {
				...
				query.append(CategoryArticleModelImpl.ORDER_BY_JPQL);
			}
	...
	public CategoryArticle findByArticle_First(
		...
		throw new NoSuchCategoryArticleException(msg.toString());
	}
	...
	protected CategoryArticle getByArticle_PrevAndNext(
		...
		List<CategoryArticle> list = q.list();
	...
	public int countByArticle(long articleId) {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_CATEGORYARTICLE_WHERE);
	...
	public List<CategoryArticle> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				query.append(_SQL_SELECT_CATEGORYARTICLE);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query q = session.createQuery(_SQL_COUNT_CATEGORYARTICLE);
