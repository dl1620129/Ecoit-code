...
/**
 * Provides the local service interface for GroupLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GroupLinkLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GroupLinkLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GroupLinkLocalServiceUtil} to access the group link local service. Add custom service methods to <code>LinkManager.Service.service.impl.GroupLinkLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GroupLink> getListGroupLink(
