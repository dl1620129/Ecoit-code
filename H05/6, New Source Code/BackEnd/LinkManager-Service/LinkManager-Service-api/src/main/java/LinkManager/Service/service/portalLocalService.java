...
public interface portalLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link portalLocalServiceUtil} to access the portal local service. Add custom service methods to <code>LinkManager.Service.service.impl.portalLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public portal createportal(long portalId);
	...
	public portal deleteportal(long portalId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public portal deleteportal(portal portal);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public portal fetchportal(long portalId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public portal fetchportalByUuidAndGroupId(String uuid, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public portal getportal(long portalId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public portal getportalByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<portal> getportals(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<portal> getportalsByUuidAndCompanyId(
