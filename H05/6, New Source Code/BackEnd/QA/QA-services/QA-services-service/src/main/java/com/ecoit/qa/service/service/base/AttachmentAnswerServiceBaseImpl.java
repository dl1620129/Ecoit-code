...
import com.ecoit.qa.service.service.AttachmentAnswerService;
...
/**
 * Provides the base implementation for the attachment answer remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.qa.service.service.impl.AttachmentAnswerServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ecoit.qa.service.service.impl.AttachmentAnswerServiceImpl
 * @generated
 */
public abstract class AttachmentAnswerServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttachmentAnswerService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttachmentAnswerService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.qa.service.service.AttachmentAnswerServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttachmentAnswerService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attachmentAnswerService = (AttachmentAnswerService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttachmentAnswerService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.qa.service.service.AttachmentAnswerLocalService
		attachmentAnswerLocalService;

	protected AttachmentAnswerService attachmentAnswerService;
