...
import com.ecoit.qa.service.service.GroupUserUserService;
...
/**
 * Provides the base implementation for the group user user remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.qa.service.service.impl.GroupUserUserServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ecoit.qa.service.service.impl.GroupUserUserServiceImpl
 * @generated
 */
public abstract class GroupUserUserServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GroupUserUserService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GroupUserUserService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.qa.service.service.GroupUserUserServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GroupUserUserService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		groupUserUserService = (GroupUserUserService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GroupUserUserService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.qa.service.service.GroupUserUserLocalService
		groupUserUserLocalService;

	protected GroupUserUserService groupUserUserService;
