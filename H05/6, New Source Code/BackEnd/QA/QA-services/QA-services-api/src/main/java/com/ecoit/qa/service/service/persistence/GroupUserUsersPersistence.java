...
public interface GroupUserUsersPersistence
	 ...
	 */
	public java.util.List<GroupUserUsers> findByUser(long userId);
	 ...
	 */
	public java.util.List<GroupUserUsers> findByUser(
	 ...
	 * @return the matching group user userses
	 */
	public java.util.List<GroupUserUsers> findByGroupUser(long groupUserId);
	 ...
	 * @return the range of matching group user userses
	 */
	public java.util.List<GroupUserUsers> findByGroupUser(
