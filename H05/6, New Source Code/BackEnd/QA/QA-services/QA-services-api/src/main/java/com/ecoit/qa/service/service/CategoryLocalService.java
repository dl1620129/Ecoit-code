...
public interface CategoryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CategoryLocalServiceUtil} to access the category local service. Add custom service methods to <code>com.ecoit.qa.service.service.impl.CategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public void createUpdateCategory(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public int getNodeCount(long parentId, long groupId, String searchKey)
		throws Exception;
