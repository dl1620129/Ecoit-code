 ...
 * @generated
 */
public class GroupUserPermissionPK
	implements Comparable<GroupUserPermissionPK>, Serializable {

	public long groupUserId;
	public long permissionId;

	public GroupUserPermissionPK() {
	}

	public GroupUserPermissionPK(long groupUserId, long permissionId) {
	...
	@Override
	public int compareTo(GroupUserPermissionPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GroupUserPermissionPK)) {
			return false;
		}

		GroupUserPermissionPK pk = (GroupUserPermissionPK)obj;
