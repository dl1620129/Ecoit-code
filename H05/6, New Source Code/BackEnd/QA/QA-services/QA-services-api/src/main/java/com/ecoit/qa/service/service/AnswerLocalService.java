...
public interface AnswerLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AnswerLocalServiceUtil} to access the answer local service. Add custom service methods to <code>com.ecoit.qa.service.service.impl.AnswerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public void createUpdateAnswer(
			...
			List<Long> attachmentIdsList, String content)
		throws Exception;
