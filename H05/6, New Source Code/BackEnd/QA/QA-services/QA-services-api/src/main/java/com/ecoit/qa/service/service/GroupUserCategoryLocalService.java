...
/**
 * Provides the local service interface for GroupUserCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GroupUserCategoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GroupUserCategoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GroupUserCategoryLocalServiceUtil} to access the group user category local service. Add custom service methods to <code>com.ecoit.qa.service.service.impl.GroupUserCategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public GroupUserCategory addGroupUserCategory(
	...
	public GroupUserCategory createGroupUserCategory(
	...
	public GroupUserCategory deleteGroupUserCategory(
		GroupUserCategory groupUserCategory);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GroupUserCategory fetchGroupUserCategory(
		GroupUserCategoryPK groupUserCategoryPK);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GroupUserCategory> getGroupUserCategories(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GroupUserCategory getGroupUserCategory(
			GroupUserCategoryPK groupUserCategoryPK)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public GroupUserCategory updateGroupUserCategory(
		GroupUserCategory groupUserCategory);
