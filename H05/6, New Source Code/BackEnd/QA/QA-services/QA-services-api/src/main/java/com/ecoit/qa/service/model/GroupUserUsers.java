...
/**
 * The extended model interface for the GroupUserUsers service. Represents a row in the &quot;ecoit_qa_GroupUserUsers&quot; database table, with each column mapped to a property of this class.
 *
 * @author Brian Wing Shun Chan
 * @see GroupUserUsersModel
 * @generated
 */
@ImplementationClassName("com.ecoit.qa.service.model.impl.GroupUserUsersImpl")
@ProviderType
public interface GroupUserUsers extends GroupUserUsersModel, PersistedModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>com.ecoit.qa.service.model.impl.GroupUserUsersImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
