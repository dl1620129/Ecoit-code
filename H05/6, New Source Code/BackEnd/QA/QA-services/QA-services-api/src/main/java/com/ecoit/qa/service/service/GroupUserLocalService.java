...
public interface GroupUserLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GroupUserLocalServiceUtil} to access the group user local service. Add custom service methods to <code>com.ecoit.qa.service.service.impl.GroupUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public List<GroupUser> findBySearchKey(
