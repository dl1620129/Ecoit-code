...
public interface LegalDocumentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalDocumentLocalServiceUtil} to access the legal document local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalDocumentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LegalDocument deleteLegalDocument(long docId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LegalDocument> getLatestDocument(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LegalDocument> getPopularDocument(
		int limit, long groupId, String language);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LegalDocument> getSuggestedDocument(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LegalDocument> searchLegalDocument(
		int statusDoc, long groupId, long companyId, String language,
		HashMap<String, Object> searchValues);

	public void updateCreateLegalDocument(
			LegalDocument legalDocument, List<Long> attachmentIds,
			long[] typeIds, List<Long> signerIds, long userId)
		throws Exception;
