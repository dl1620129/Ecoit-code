...
/**
 * Provides the local service interface for LegalDFRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalDFRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalDFRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalDFRelLocalServiceUtil} to access the legal df rel local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalDFRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
