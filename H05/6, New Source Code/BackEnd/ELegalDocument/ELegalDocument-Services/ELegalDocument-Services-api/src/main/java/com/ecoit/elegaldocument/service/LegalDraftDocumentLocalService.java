...
/**
 * Provides the local service interface for LegalDraftDocument. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalDraftDocumentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalDraftDocumentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalDraftDocumentLocalServiceUtil} to access the legal draft document local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalDraftDocumentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
