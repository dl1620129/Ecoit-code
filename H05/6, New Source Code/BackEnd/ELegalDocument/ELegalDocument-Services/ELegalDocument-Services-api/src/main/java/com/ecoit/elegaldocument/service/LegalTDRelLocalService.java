...
/**
 * Provides the local service interface for LegalTDRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalTDRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalTDRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalTDRelLocalServiceUtil} to access the legal td rel local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalTDRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
