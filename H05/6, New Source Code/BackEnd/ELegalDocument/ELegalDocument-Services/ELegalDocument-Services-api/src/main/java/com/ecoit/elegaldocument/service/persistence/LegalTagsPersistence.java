...
/**
 * The persistence interface for the legal tags service.
 *
 * <p>
 ...
 */
@ProviderType
public interface LegalTagsPersistence extends BasePersistence<LegalTags> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalTagsUtil} to access the legal tags persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<LegalTags> findByGroupId(long groupId);
	 ...
	 */
	public java.util.List<LegalTags> findByGroupId(
	...
	public java.util.List<LegalTags> findByGroupId(
		long groupId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<LegalTags>
			orderByComparator);
	 ...
	 * @return the matching legal tagses
	 */
	public java.util.List<LegalTags> findByP_S(
	 ...
	 */
	public void cacheResult(java.util.List<LegalTags> legalTagses);
	 ...
	 */
	public java.util.List<LegalTags> findAll();
	 ...
	 */
	public java.util.List<LegalTags> findAll(int start, int end);
