...
/**
 * Provides the local service interface for LegalField. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalFieldLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalFieldLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalFieldLocalServiceUtil} to access the legal field local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalFieldLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LegalField> getListLegalField(
		String name, long groupId, String language, long companyId, int start,
		int limit);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LegalField> getPublishFields(
		String language, boolean statusField, long groupId);
