...
/**
 * Provides the local service interface for LegalDDRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalDDRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalDDRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalDDRelLocalServiceUtil} to access the legal dd rel local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalDDRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
