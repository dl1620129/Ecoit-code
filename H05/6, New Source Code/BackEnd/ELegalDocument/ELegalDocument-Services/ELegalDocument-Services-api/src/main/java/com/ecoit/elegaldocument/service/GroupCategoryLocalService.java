...
/**
 * Provides the local service interface for GroupCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see GroupCategoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GroupCategoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GroupCategoryLocalServiceUtil} to access the group category local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.GroupCategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GroupCategory> getByUserIdAndGroupIdAndGroupUserId(
