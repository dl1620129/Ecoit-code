...
/**
 * Provides the local service interface for LegalLogger. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalLoggerLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalLoggerLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalLoggerLocalServiceUtil} to access the legal logger local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalLoggerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
