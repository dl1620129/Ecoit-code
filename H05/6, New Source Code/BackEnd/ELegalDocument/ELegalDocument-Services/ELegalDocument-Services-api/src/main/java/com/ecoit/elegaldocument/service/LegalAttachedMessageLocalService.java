...
/**
 * Provides the local service interface for LegalAttachedMessage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalAttachedMessageLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalAttachedMessageLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalAttachedMessageLocalServiceUtil} to access the legal attached message local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalAttachedMessageLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public LegalAttachedMessage addLegalAttachedMessage(
	...
	public LegalAttachedMessage createLegalAttachedMessage(String messageId);
	...
	public LegalAttachedMessage deleteLegalAttachedMessage(
		LegalAttachedMessage legalAttachedMessage);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LegalAttachedMessage deleteLegalAttachedMessage(String messageId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LegalAttachedMessage fetchLegalAttachedMessage(String messageId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LegalAttachedMessage getLegalAttachedMessage(String messageId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LegalAttachedMessage> getLegalAttachedMessages(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LegalAttachedMessage updateLegalAttachedMessage(
		LegalAttachedMessage legalAttachedMessage);
