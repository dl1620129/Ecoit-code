...
/**
 * Provides the local service interface for EcmsGURelation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see EcmsGURelationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EcmsGURelationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EcmsGURelationLocalServiceUtil} to access the ecms gu relation local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.EcmsGURelationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
