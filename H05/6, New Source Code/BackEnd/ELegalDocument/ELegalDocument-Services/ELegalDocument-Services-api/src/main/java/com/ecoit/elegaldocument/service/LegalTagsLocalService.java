...
/**
 * Provides the local service interface for LegalTags. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalTagsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalTagsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalTagsLocalServiceUtil} to access the legal tags local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalTagsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public LegalTags addLegalTags(LegalTags legalTags);
	...
	public LegalTags createLegalTags(long tagId);
	...
	public LegalTags deleteLegalTags(LegalTags legalTags);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LegalTags deleteLegalTags(long tagId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LegalTags fetchLegalTags(long tagId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LegalTags getLegalTags(long tagId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LegalTags> getLegalTagses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LegalTags updateLegalTags(LegalTags legalTags);
