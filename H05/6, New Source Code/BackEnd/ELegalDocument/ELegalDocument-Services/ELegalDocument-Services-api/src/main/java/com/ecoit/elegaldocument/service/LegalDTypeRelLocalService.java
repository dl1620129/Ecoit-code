...
/**
 * Provides the local service interface for LegalDTypeRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Liverpool
 * @see LegalDTypeRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LegalDTypeRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LegalDTypeRelLocalServiceUtil} to access the legal d type rel local service. Add custom service methods to <code>com.ecoit.elegaldocument.service.impl.LegalDTypeRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public LegalDTypeRel addLegalDTypeRel(LegalDTypeRel legalDTypeRel);
	...
	public LegalDTypeRel createLegalDTypeRel(LegalDTypeRelPK legalDTypeRelPK);
	...
	public LegalDTypeRel deleteLegalDTypeRel(LegalDTypeRel legalDTypeRel);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LegalDTypeRel deleteLegalDTypeRel(LegalDTypeRelPK legalDTypeRelPK)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LegalDTypeRel fetchLegalDTypeRel(LegalDTypeRelPK legalDTypeRelPK);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LegalDTypeRel getLegalDTypeRel(LegalDTypeRelPK legalDTypeRelPK)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LegalDTypeRel> getLegalDTypeRels(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LegalDTypeRel updateLegalDTypeRel(LegalDTypeRel legalDTypeRel);
