...
import com.ecoit.elegaldocument.service.LegalTagsLocalService;
...
/**
 * Provides the base implementation for the legal tags local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalTagsLocalServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalTagsLocalServiceImpl
 * @generated
 */
public abstract class LegalTagsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LegalTagsLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalTagsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalTagsLocalServiceUtil</code>.
	 */
	...
	public LegalTags addLegalTags(LegalTags legalTags) {
		...
		return legalTagsPersistence.update(legalTags);
	}
	...
	public LegalTags createLegalTags(long tagId) {
		return legalTagsPersistence.create(tagId);
	}
	...
	public LegalTags deleteLegalTags(long tagId) throws PortalException {
		return legalTagsPersistence.remove(tagId);
	}
	...
	public LegalTags deleteLegalTags(LegalTags legalTags) {
		return legalTagsPersistence.remove(legalTags);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LegalTags.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return legalTagsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return legalTagsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return legalTagsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return legalTagsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LegalTags fetchLegalTags(long tagId) {
		return legalTagsPersistence.fetchByPrimaryKey(tagId);
	}
	...
	public LegalTags getLegalTags(long tagId) throws PortalException {
		return legalTagsPersistence.findByPrimaryKey(tagId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(legalTagsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LegalTags.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			legalTagsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LegalTags.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return legalTagsLocalService.deleteLegalTags((LegalTags)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return legalTagsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LegalTags> getLegalTagses(int start, int end) {
		return legalTagsPersistence.findAll(start, end);
	}
	...
	public int getLegalTagsesCount() {
		return legalTagsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalTagsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		legalTagsLocalService = (LegalTagsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalTagsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = legalTagsPersistence.getDataSource();
	...
	protected LegalTagsLocalService legalTagsLocalService;
