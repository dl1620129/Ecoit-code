...
import com.ecoit.elegaldocument.service.LegalDTypeRelLocalService;
...
/**
 * Provides the base implementation for the legal d type rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalDTypeRelLocalServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalDTypeRelLocalServiceImpl
 * @generated
 */
public abstract class LegalDTypeRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LegalDTypeRelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalDTypeRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalDTypeRelLocalServiceUtil</code>.
	 */
	...
	public LegalDTypeRel addLegalDTypeRel(LegalDTypeRel legalDTypeRel) {
		...
		return legalDTypeRelPersistence.update(legalDTypeRel);
	}
	...
	public LegalDTypeRel createLegalDTypeRel(LegalDTypeRelPK legalDTypeRelPK) {
		return legalDTypeRelPersistence.create(legalDTypeRelPK);
	}
	...
	public LegalDTypeRel deleteLegalDTypeRel(LegalDTypeRelPK legalDTypeRelPK)
		...
		return legalDTypeRelPersistence.remove(legalDTypeRelPK);
	}
	...
	public LegalDTypeRel deleteLegalDTypeRel(LegalDTypeRel legalDTypeRel) {
		return legalDTypeRelPersistence.remove(legalDTypeRel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LegalDTypeRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return legalDTypeRelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return legalDTypeRelPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return legalDTypeRelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return legalDTypeRelPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LegalDTypeRel fetchLegalDTypeRel(LegalDTypeRelPK legalDTypeRelPK) {
		return legalDTypeRelPersistence.fetchByPrimaryKey(legalDTypeRelPK);
	}
	...
	public LegalDTypeRel getLegalDTypeRel(LegalDTypeRelPK legalDTypeRelPK)
		...
		return legalDTypeRelPersistence.findByPrimaryKey(legalDTypeRelPK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(legalDTypeRelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LegalDTypeRel.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			legalDTypeRelLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LegalDTypeRel.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return legalDTypeRelLocalService.deleteLegalDTypeRel(
			(LegalDTypeRel)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return legalDTypeRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LegalDTypeRel> getLegalDTypeRels(int start, int end) {
		return legalDTypeRelPersistence.findAll(start, end);
	}
	...
	public int getLegalDTypeRelsCount() {
		return legalDTypeRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalDTypeRelLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		legalDTypeRelLocalService = (LegalDTypeRelLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalDTypeRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = legalDTypeRelPersistence.getDataSource();
	...
	protected LegalDTypeRelLocalService legalDTypeRelLocalService;
