...
import com.ecoit.elegaldocument.service.EcmsGroupLocalService;
...
/**
 * Provides the base implementation for the ecms group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.EcmsGroupLocalServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.EcmsGroupLocalServiceImpl
 * @generated
 */
public abstract class EcmsGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EcmsGroupLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EcmsGroupLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.EcmsGroupLocalServiceUtil</code>.
	 */
	...
	public EcmsGroup addEcmsGroup(EcmsGroup ecmsGroup) {
		...
		return ecmsGroupPersistence.update(ecmsGroup);
	}
	...
	public EcmsGroup createEcmsGroup(long groupUserId) {
		return ecmsGroupPersistence.create(groupUserId);
	}
	...
	public EcmsGroup deleteEcmsGroup(long groupUserId) throws PortalException {
		return ecmsGroupPersistence.remove(groupUserId);
	}
	...
	public EcmsGroup deleteEcmsGroup(EcmsGroup ecmsGroup) {
		return ecmsGroupPersistence.remove(ecmsGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EcmsGroup.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ecmsGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ecmsGroupPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ecmsGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ecmsGroupPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EcmsGroup fetchEcmsGroup(long groupUserId) {
		return ecmsGroupPersistence.fetchByPrimaryKey(groupUserId);
	}
	...
	public EcmsGroup getEcmsGroup(long groupUserId) throws PortalException {
		return ecmsGroupPersistence.findByPrimaryKey(groupUserId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ecmsGroupLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EcmsGroup.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			ecmsGroupLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EcmsGroup.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return ecmsGroupLocalService.deleteEcmsGroup((EcmsGroup)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ecmsGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EcmsGroup> getEcmsGroups(int start, int end) {
		return ecmsGroupPersistence.findAll(start, end);
	}
	...
	public int getEcmsGroupsCount() {
		return ecmsGroupPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EcmsGroupLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ecmsGroupLocalService = (EcmsGroupLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EcmsGroupLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ecmsGroupPersistence.getDataSource();
	...
	protected EcmsGroupLocalService ecmsGroupLocalService;
