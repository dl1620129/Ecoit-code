...
import com.ecoit.elegaldocument.service.EcmsGroupService;
...
/**
 * Provides the base implementation for the ecms group remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.EcmsGroupServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.EcmsGroupServiceImpl
 * @generated
 */
public abstract class EcmsGroupServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EcmsGroupService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EcmsGroupService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.EcmsGroupServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EcmsGroupService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ecmsGroupService = (EcmsGroupService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EcmsGroupService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.EcmsGroupLocalService
		ecmsGroupLocalService;

	protected EcmsGroupService ecmsGroupService;
