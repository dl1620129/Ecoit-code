...
import com.ecoit.elegaldocument.service.LegalAttachedMessageLocalService;
...
/**
 * Provides the base implementation for the legal attached message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalAttachedMessageLocalServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalAttachedMessageLocalServiceImpl
 * @generated
 */
public abstract class LegalAttachedMessageLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalAttachedMessageLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalAttachedMessageLocalServiceUtil</code>.
	 */
	...
	public LegalAttachedMessage addLegalAttachedMessage(
		...
		return legalAttachedMessagePersistence.update(legalAttachedMessage);
	}
	...
	public LegalAttachedMessage createLegalAttachedMessage(String messageId) {
		return legalAttachedMessagePersistence.create(messageId);
	}
	...
	public LegalAttachedMessage deleteLegalAttachedMessage(String messageId)
		...
		return legalAttachedMessagePersistence.remove(messageId);
	}
	...
	public LegalAttachedMessage deleteLegalAttachedMessage(
		...
		return legalAttachedMessagePersistence.remove(legalAttachedMessage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LegalAttachedMessage.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return legalAttachedMessagePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return legalAttachedMessagePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public LegalAttachedMessage fetchLegalAttachedMessage(String messageId) {
		return legalAttachedMessagePersistence.fetchByPrimaryKey(messageId);
	}
	...
	public LegalAttachedMessage getLegalAttachedMessage(String messageId)
		...
		return legalAttachedMessagePersistence.findByPrimaryKey(messageId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return legalAttachedMessageLocalService.deleteLegalAttachedMessage(
			(LegalAttachedMessage)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return legalAttachedMessagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LegalAttachedMessage> getLegalAttachedMessages(
		...
		return legalAttachedMessagePersistence.findAll(start, end);
	}
	...
	public int getLegalAttachedMessagesCount() {
		return legalAttachedMessagePersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		legalAttachedMessageLocalService =
			(LegalAttachedMessageLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalAttachedMessageLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				legalAttachedMessagePersistence.getDataSource();
	...
	protected LegalAttachedMessageLocalService legalAttachedMessageLocalService;
