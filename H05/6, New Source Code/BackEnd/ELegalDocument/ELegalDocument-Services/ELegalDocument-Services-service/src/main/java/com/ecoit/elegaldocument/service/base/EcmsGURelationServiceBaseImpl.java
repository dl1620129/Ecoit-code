...
import com.ecoit.elegaldocument.service.EcmsGURelationService;
...
/**
 * Provides the base implementation for the ecms gu relation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.EcmsGURelationServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.EcmsGURelationServiceImpl
 * @generated
 */
public abstract class EcmsGURelationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EcmsGURelationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EcmsGURelationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.EcmsGURelationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EcmsGURelationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ecmsGURelationService = (EcmsGURelationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EcmsGURelationService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.EcmsGURelationLocalService
		ecmsGURelationLocalService;

	protected EcmsGURelationService ecmsGURelationService;
