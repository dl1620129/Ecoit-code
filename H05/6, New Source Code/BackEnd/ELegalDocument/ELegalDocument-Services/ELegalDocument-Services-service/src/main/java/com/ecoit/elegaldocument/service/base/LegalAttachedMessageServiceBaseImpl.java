...
import com.ecoit.elegaldocument.service.LegalAttachedMessageService;
...
/**
 * Provides the base implementation for the legal attached message remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalAttachedMessageServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalAttachedMessageServiceImpl
 * @generated
 */
public abstract class LegalAttachedMessageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   LegalAttachedMessageService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalAttachedMessageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalAttachedMessageServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalAttachedMessageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalAttachedMessageService = (LegalAttachedMessageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalAttachedMessageService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalAttachedMessageLocalService
		legalAttachedMessageLocalService;

	protected LegalAttachedMessageService legalAttachedMessageService;
