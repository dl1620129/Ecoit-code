...
import com.ecoit.elegaldocument.service.LegalDURelService;
...
/**
 * Provides the base implementation for the legal du rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalDURelServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalDURelServiceImpl
 * @generated
 */
public abstract class LegalDURelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LegalDURelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalDURelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalDURelServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalDURelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalDURelService = (LegalDURelService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalDURelService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalDURelLocalService
		legalDURelLocalService;

	protected LegalDURelService legalDURelService;
