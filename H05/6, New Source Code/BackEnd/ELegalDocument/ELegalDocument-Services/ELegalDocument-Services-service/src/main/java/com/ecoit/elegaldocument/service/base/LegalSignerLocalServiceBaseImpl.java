...
import com.ecoit.elegaldocument.service.LegalSignerLocalService;
...
/**
 * Provides the base implementation for the legal signer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalSignerLocalServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalSignerLocalServiceImpl
 * @generated
 */
public abstract class LegalSignerLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LegalSignerLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalSignerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalSignerLocalServiceUtil</code>.
	 */
	...
	public LegalSigner addLegalSigner(LegalSigner legalSigner) {
		...
		return legalSignerPersistence.update(legalSigner);
	}
	...
	public LegalSigner createLegalSigner(long sigId) {
		return legalSignerPersistence.create(sigId);
	}
	...
	public LegalSigner deleteLegalSigner(long sigId) throws PortalException {
		return legalSignerPersistence.remove(sigId);
	}
	...
	public LegalSigner deleteLegalSigner(LegalSigner legalSigner) {
		return legalSignerPersistence.remove(legalSigner);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LegalSigner.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return legalSignerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return legalSignerPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return legalSignerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return legalSignerPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LegalSigner fetchLegalSigner(long sigId) {
		return legalSignerPersistence.fetchByPrimaryKey(sigId);
	}
	...
	public LegalSigner getLegalSigner(long sigId) throws PortalException {
		return legalSignerPersistence.findByPrimaryKey(sigId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(legalSignerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LegalSigner.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("sigId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			legalSignerLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LegalSigner.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("sigId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return legalSignerLocalService.deleteLegalSigner(
			(LegalSigner)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return legalSignerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LegalSigner> getLegalSigners(int start, int end) {
		return legalSignerPersistence.findAll(start, end);
	}
	...
	public int getLegalSignersCount() {
		return legalSignerPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalSignerLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		legalSignerLocalService = (LegalSignerLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalSignerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = legalSignerPersistence.getDataSource();
	...
	protected LegalSignerLocalService legalSignerLocalService;
