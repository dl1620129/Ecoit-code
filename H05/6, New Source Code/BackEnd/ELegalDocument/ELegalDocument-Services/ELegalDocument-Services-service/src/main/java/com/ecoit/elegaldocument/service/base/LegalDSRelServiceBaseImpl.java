...
import com.ecoit.elegaldocument.service.LegalDSRelService;
...
/**
 * Provides the base implementation for the legal ds rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.LegalDSRelServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.LegalDSRelServiceImpl
 * @generated
 */
public abstract class LegalDSRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LegalDSRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LegalDSRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.LegalDSRelServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LegalDSRelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		legalDSRelService = (LegalDSRelService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LegalDSRelService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.LegalDSRelLocalService
		legalDSRelLocalService;

	protected LegalDSRelService legalDSRelService;
