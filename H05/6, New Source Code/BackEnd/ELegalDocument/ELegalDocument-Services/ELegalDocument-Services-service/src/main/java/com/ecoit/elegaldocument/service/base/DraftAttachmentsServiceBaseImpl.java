...
import com.ecoit.elegaldocument.service.DraftAttachmentsService;
...
/**
 * Provides the base implementation for the draft attachments remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ecoit.elegaldocument.service.impl.DraftAttachmentsServiceImpl}.
 * </p>
 *
 * @author Liverpool
 * @see com.ecoit.elegaldocument.service.impl.DraftAttachmentsServiceImpl
 * @generated
 */
public abstract class DraftAttachmentsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DraftAttachmentsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DraftAttachmentsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ecoit.elegaldocument.service.DraftAttachmentsServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DraftAttachmentsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		draftAttachmentsService = (DraftAttachmentsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DraftAttachmentsService.class.getName();
	}
	...
	@Reference
	protected com.ecoit.elegaldocument.service.DraftAttachmentsLocalService
		draftAttachmentsLocalService;

	protected DraftAttachmentsService draftAttachmentsService;
