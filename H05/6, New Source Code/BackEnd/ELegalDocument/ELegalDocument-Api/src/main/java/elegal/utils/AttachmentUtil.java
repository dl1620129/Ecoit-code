...
public class AttachmentUtil {
	...
	public static long uploadFile(UploadServletRequest upload, File file, String title, long docId, String locale,
			String docTitle, long scopeGroupId, long userId) throws PortalException, SystemException {
		long entryId = 0;
		...
		try {
			...
			if (dlFolder == null) {
				dlFolder = DLFolderLocalServiceUtil.addFolder(userId, scopeGroupId, scopeGroupId, false,
						folderMonth.getFolderId(), "DocImage_" + docId, docTitle,
