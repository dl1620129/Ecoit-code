...
public class UserPermissionGroupUtil {
	...
	public static UserPermissionGroup remove(long userPermissionGroupId)
		throws com.ecoit.lichcongtac.services.exception.
			NoSuchUserPermissionGroupException {
