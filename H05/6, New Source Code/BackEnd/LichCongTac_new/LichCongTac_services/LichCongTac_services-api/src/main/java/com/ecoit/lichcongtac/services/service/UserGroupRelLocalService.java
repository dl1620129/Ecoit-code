...
/**
 * Provides the local service interface for UserGroupRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserGroupRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserGroupRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserGroupRelLocalServiceUtil} to access the user group rel local service. Add custom service methods to <code>com.ecoit.lichcongtac.services.service.impl.UserGroupRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
