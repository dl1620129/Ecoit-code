...
public class UserPermissionGroupLocalServiceWrapper
	 ...
	 */
	@Override
	public com.ecoit.lichcongtac.services.model.UserPermissionGroup
	...
	public int countTotalGroup(long groupId, String q) {
		return _userPermissionGroupLocalService.countTotalGroup(groupId, q);
	}
	...
	public java.util.List
		...
		return _userPermissionGroupLocalService.findBySearchKey(
	...
	public java.util.List<Object> getListOfUser(long scopeGroupId)
		...
		return _userPermissionGroupLocalService.getListOfUser(scopeGroupId);
	}
	...
	public void removeGroupUser(long groupUserId) throws Exception {
		_userPermissionGroupLocalService.removeGroupUser(groupUserId);
	}
