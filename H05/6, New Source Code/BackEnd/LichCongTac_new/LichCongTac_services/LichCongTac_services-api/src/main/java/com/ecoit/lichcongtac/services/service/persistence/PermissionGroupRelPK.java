 ...
 * @generated
 */
public class PermissionGroupRelPK
	implements Comparable<PermissionGroupRelPK>, Serializable {

	public long userPermissionGroupId;
	public int permissionId;

	public PermissionGroupRelPK() {
	}

	public PermissionGroupRelPK(long userPermissionGroupId, int permissionId) {
	...
	@Override
	public int compareTo(PermissionGroupRelPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PermissionGroupRelPK)) {
			return false;
		}

		PermissionGroupRelPK pk = (PermissionGroupRelPK)obj;
