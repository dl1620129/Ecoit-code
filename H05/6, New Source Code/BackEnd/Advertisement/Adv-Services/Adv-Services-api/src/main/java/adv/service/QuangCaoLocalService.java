...
/**
 * Provides the local service interface for QuangCao. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see QuangCaoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface QuangCaoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QuangCaoLocalServiceUtil} to access the quang cao local service. Add custom service methods to <code>adv.service.impl.QuangCaoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public QuangCao addQuangCao(QuangCao quangCao);
	...
	public QuangCao createQuangCao(long quangCaoId);
	...
	public QuangCao deleteQuangCao(long quangCaoId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public QuangCao deleteQuangCao(QuangCao quangCao);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QuangCao fetchQuangCao(long quangCaoId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QuangCao fetchQuangCaoByUuidAndGroupId(String uuid, long groupId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<QuangCao> getAllAdv(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QuangCao getQuangCao(long quangCaoId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QuangCao getQuangCaoByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public QuangCao updateQuangCao(QuangCao quangCao);
