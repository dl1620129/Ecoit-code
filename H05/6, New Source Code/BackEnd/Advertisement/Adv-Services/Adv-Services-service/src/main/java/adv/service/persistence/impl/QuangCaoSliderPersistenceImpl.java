...
import adv.exception.NoSuchQuangCaoSliderException;

import adv.model.QuangCaoSlider;
import adv.model.impl.QuangCaoSliderImpl;
import adv.model.impl.QuangCaoSliderModelImpl;

import adv.service.persistence.QuangCaoSliderPersistence;
...
public class QuangCaoSliderPersistenceImpl
	...
	public List<QuangCaoSlider> findByUuid(
		...
		List<QuangCaoSlider> list = null;

		if (useFinderCache) {
			list = (List<QuangCaoSlider>)finderCache.getResult(
	...
	/**
	 * Returns the quang cao slider where uuid = &#63; and groupId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param uuid the uuid
	 * @param groupId the group ID
	...
	public List<QuangCaoSlider> findBybyQuangCaoIdAndGroupId(
		...
		return findBybyQuangCaoIdAndGroupId(
			quangCaoId, groupId, start, end, orderByComparator, true);
	}
	...
	/**
	 * Returns the quang cao slider where quangCaoSliderId = &#63; and groupId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param quangCaoSliderId the quang cao slider ID
	 * @param groupId the group ID
	 * @return the matching quang cao slider, or <code>null</code> if a matching quang cao slider could not be found
	...
	public QuangCaoSlider fetchBybyQuangCaoSliderIdAndGroupId(
		...
		return fetchBybyQuangCaoSliderIdAndGroupId(
			quangCaoSliderId, groupId, true);
	}
	...
	public QuangCaoSlider fetchBybyQuangCaoSliderIdAndGroupId(
		...
		if (useFinderCache) {
			finderArgs = new Object[] {quangCaoSliderId, groupId};
		}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, QuangCaoSliderImpl.class, primaryKey);
		}
	}
	...
	public QuangCaoSlider remove(Serializable primaryKey)
		...
		catch (NoSuchQuangCaoSliderException noSuchEntityException) {
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.adv.model.QuangCaoSlider"),
			true);
	}
