...
import User.Rank.Poisition.Service.service.UserRankPositionLocalService;
...
/**
 * Provides the base implementation for the user rank position local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link User.Rank.Poisition.Service.service.impl.UserRankPositionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see User.Rank.Poisition.Service.service.impl.UserRankPositionLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class UserRankPositionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements UserRankPositionLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UserRankPositionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>User.Rank.Poisition.Service.service.UserRankPositionLocalServiceUtil</code>.
	 */
	...
	public UserRankPosition addUserRankPosition(
		...
		return userRankPositionPersistence.update(userRankPosition);
	}
	...
	public UserRankPosition createUserRankPosition(long userId) {
		return userRankPositionPersistence.create(userId);
	}
	...
	public UserRankPosition deleteUserRankPosition(long userId)
		...
		return userRankPositionPersistence.remove(userId);
	}
	...
	public UserRankPosition deleteUserRankPosition(
		...
		return userRankPositionPersistence.remove(userRankPosition);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			UserRankPosition.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userRankPositionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return userRankPositionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userRankPositionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return userRankPositionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public UserRankPosition fetchUserRankPosition(long userId) {
		return userRankPositionPersistence.fetchByPrimaryKey(userId);
	}
	...
	public UserRankPosition getUserRankPosition(long userId)
		...
		return userRankPositionPersistence.findByPrimaryKey(userId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(UserRankPosition.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(UserRankPosition.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return userRankPositionLocalService.deleteUserRankPosition(
			(UserRankPosition)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return userRankPositionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<UserRankPosition> getUserRankPositions(int start, int end) {
		return userRankPositionPersistence.findAll(start, end);
	}
	...
	public int getUserRankPositionsCount() {
		return userRankPositionPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UserRankPositionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		userRankPositionLocalService = (UserRankPositionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserRankPositionLocalService.class.getName();
	}
	...
	protected UserRankPositionLocalService userRankPositionLocalService;
