...
/**
 * Provides the local service interface for UserChucDanh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserChucDanhLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserChucDanhLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserChucDanhLocalServiceUtil} to access the user chuc danh local service. Add custom service methods to <code>User.Rank.Poisition.Service.service.impl.UserChucDanhLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserChucDanh> getListUserChucDanh(
