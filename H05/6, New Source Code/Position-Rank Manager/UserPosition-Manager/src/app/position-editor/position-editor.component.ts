...
@Component({
    ...
    templateUrl: 
		...
		'/o/UserPosition-Manager/app/position-editor.component.html'
})
export class PositionEditorConponent implements OnInit{
    pageSize= 5;
    page = 1;
    listSize = 0;
    imgSrc: any;
    ...
    updateform = this.fb.group({
        ...
        userPoisitionName: ['', [Validators.required, Validators.maxLength(500),Validators.pattern(".*\\S.*")]],
        description: ['', [Validators.maxLength(500),Validators.pattern(".*\\S.*")]],
    });
    get userPoisitionName(){ 
        return this.updateform.get('userPoisitionName');
    }
        ...
        if(this.rankId !=null){
            this.service.getCategory(this.rankId).subscribe((res:any)=>{
                this.updateform.patchValue({
                    userPoisitionName:res.data.userPoisitionName,
