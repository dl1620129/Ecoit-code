...
export class Constants {
    ...
    public static DELETE_PARAM_MESSAGE = "Hiện đang có văn bản với người ký này. Bạn hãy xóa hết văn bản liên quan trước khi xóa người ký này.";
    
    public static NOT_ACCESS_MESSAGE = 'Bạn hiện tại không có quyền chỉnh sửa thông tin người ký văn bản.';
    ...
    public static CONFLICT_ERROR = 'CONFLICT_ERROR';
}