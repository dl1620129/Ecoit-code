...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${css_folder}/architect.css"/>
	<@liferay_util["include"] page=top_head_include />
    <script type="text/javascript" src="${javascript_folder}/architect.js"></script>
</head>
							...
							<div class="widget-content-left">
                                <div class="btn-group">
                                    ...
                                    <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                        <a href="${my_account_url}" tabindex="0" class="dropdown-item">Hồ sơ</a>
...
<script src="/o/frontend-editor-ckeditor-web/ckeditor/ckeditor.js"></script>
<script>
