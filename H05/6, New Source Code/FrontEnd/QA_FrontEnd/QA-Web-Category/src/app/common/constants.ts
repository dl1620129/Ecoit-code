...
export class Constants {
    ...
    public static NOT_ACCESS_MESSAGE = 'Bạn hiện tại không có quyền chỉnh sửa các lĩnh vực phản hồi.';

    public static CONFLICT_MESSAGE = 'Hiện đang có phản hồi sử chuyên mục hoặc chuyên mục con. Hãy xóa phản hồi đó trước khi xóa chuyên mục này.';
    ...
    public static CONFLICT_CODE = 'CONFLICT_ERROR';
}